...
class CycleRoutingTask final :
 ...
 public:
  ...
  explicit constexpr CycleRoutingTask(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class ParkingRoutingTask final :
 ...
 public:
  ...
  explicit constexpr ParkingRoutingTask(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class DeadEndRoutingTask final :
 ...
 public:
  ...
  explicit constexpr DeadEndRoutingTask(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::routing::RoutingRequest* release_routing_request_in();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::routing::RoutingRequest* release_routing_request_out();
...
class Task final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::task_manager::CycleRoutingTask* release_cycle_routing_task();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::task_manager::ParkingRoutingTask* release_parking_routing_task();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::task_manager::DeadEndRoutingTask* release_dead_end_routing_task();
...
inline ::apollo::task_manager::CycleRoutingTask* Task::_internal_mutable_cycle_routing_task() {
  if (!_internal_has_cycle_routing_task()) {
    clear_routing_task();
    set_has_cycle_routing_task();
    routing_task_.cycle_routing_task_ = CreateMaybeMessage< ::apollo::task_manager::CycleRoutingTask >(GetArenaForAllocation());
  }
...
inline ::apollo::task_manager::ParkingRoutingTask* Task::_internal_mutable_parking_routing_task() {
  if (!_internal_has_parking_routing_task()) {
    clear_routing_task();
    set_has_parking_routing_task();
    routing_task_.parking_routing_task_ = CreateMaybeMessage< ::apollo::task_manager::ParkingRoutingTask >(GetArenaForAllocation());
  }
...
inline ::apollo::task_manager::DeadEndRoutingTask* Task::_internal_mutable_dead_end_routing_task() {
  if (!_internal_has_dead_end_routing_task()) {
    clear_routing_task();
    set_has_dead_end_routing_task();
    routing_task_.dead_end_routing_task_ = CreateMaybeMessage< ::apollo::task_manager::DeadEndRoutingTask >(GetArenaForAllocation());
  }
