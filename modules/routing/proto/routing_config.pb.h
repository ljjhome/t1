...
class TopicConfig final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_routing_response_history_topic();
...
class RoutingConfig final :
 ...
 public:
  ...
  explicit constexpr RoutingConfig(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::routing::TopicConfig* release_topic_config();
...
void TopicConfig::set_routing_response_history_topic(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 routing_response_history_topic_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void TopicConfig::_internal_set_routing_response_history_topic(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  routing_response_history_topic_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* TopicConfig::_internal_mutable_routing_response_history_topic() {
  _has_bits_[0] |= 0x00000002u;
  return routing_response_history_topic_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* TopicConfig::release_routing_response_history_topic() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  return routing_response_history_topic_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
...
inline void RoutingConfig::set_allocated_topic_config(::apollo::routing::TopicConfig* topic_config) {
  ...
  if (topic_config) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::apollo::routing::TopicConfig>::GetOwningArena(topic_config);
