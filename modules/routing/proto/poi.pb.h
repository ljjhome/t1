...
class Landmark final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT PROTOBUF_DEPRECATED std::string* release_parking_space_id();
...
class POI final :
 ...
 public:
  ...
  ~POI() override;
  explicit constexpr POI(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
