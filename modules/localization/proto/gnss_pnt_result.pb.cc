...
constexpr SatDirCosine::SatDirCosine(
...
struct SatDirCosineDefaultTypeInternal {
  constexpr SatDirCosineDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT SatDirCosineDefaultTypeInternal _SatDirCosine_default_instance_;
constexpr GnssPntResult::GnssPntResult(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : sat_dir_cosine_()
  , receiver_id_(0u)
  , gnss_week_(0u)
...
struct GnssPntResultDefaultTypeInternal {
  constexpr GnssPntResultDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT GnssPntResultDefaultTypeInternal _GnssPntResult_default_instance_;
}  // namespace localization
}  // namespace apollo
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2flocalization_2fproto_2fgnss_5fpnt_5fresult_2eproto = {
  false, false, 905, descriptor_table_protodef_modules_2flocalization_2fproto_2fgnss_5fpnt_5fresult_2eproto, "modules/localization/proto/gnss_pnt_result.proto", 
  ...
  file_level_metadata_modules_2flocalization_2fproto_2fgnss_5fpnt_5fresult_2eproto, file_level_enum_descriptors_modules_2flocalization_2fproto_2fgnss_5fpnt_5fresult_2eproto, file_level_service_descriptors_modules_2flocalization_2fproto_2fgnss_5fpnt_5fresult_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_modules_2flocalization_2fproto_2fgnss_5fpnt_5fresult_2eproto_getter() {
  return &descriptor_table_modules_2flocalization_2fproto_2fgnss_5fpnt_5fresult_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_modules_2flocalization_2fproto_2fgnss_5fpnt_5fresult_2eproto(&descriptor_table_modules_2flocalization_2fproto_2fgnss_5fpnt_5fresult_2eproto);
namespace apollo {
namespace localization {
...
// @@protoc_insertion_point(message_byte_size_start:apollo.localization.SatDirCosine)
  ...
  if (cached_has_bits & 0x0000001fu) {
    ...
    // optional uint32 sat_sys = 2;
    if (cached_has_bits & 0x00000002u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_sat_sys());
    }
