...
class Pose final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::common::Point3D* release_linear_acceleration_vrf();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::common::Point3D* release_angular_velocity_vrf();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::common::Point3D* release_euler_angles();
