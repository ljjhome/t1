...
class IntegSinsPva final :
 ...
 public:
  ...
  explicit constexpr IntegSinsPva(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::common::Point3D* release_attitude();
