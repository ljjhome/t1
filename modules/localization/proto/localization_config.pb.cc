...
constexpr LocalizationConfig::LocalizationConfig(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : localization_type_(0)
{}
struct LocalizationConfigDefaultTypeInternal {
  constexpr LocalizationConfigDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT LocalizationConfigDefaultTypeInternal _LocalizationConfig_default_instance_;
}  // namespace localization
}  // namespace apollo
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2flocalization_2fproto_2flocalization_5fconfig_2eproto = {
  false, false, 226, descriptor_table_protodef_modules_2flocalization_2fproto_2flocalization_5fconfig_2eproto, "modules/localization/proto/localization_config.proto", 
  ...
  file_level_metadata_modules_2flocalization_2fproto_2flocalization_5fconfig_2eproto, file_level_enum_descriptors_modules_2flocalization_2fproto_2flocalization_5fconfig_2eproto, file_level_service_descriptors_modules_2flocalization_2fproto_2flocalization_5fconfig_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_modules_2flocalization_2fproto_2flocalization_5fconfig_2eproto_getter() {
  return &descriptor_table_modules_2flocalization_2fproto_2flocalization_5fconfig_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_modules_2flocalization_2fproto_2flocalization_5fconfig_2eproto(&descriptor_table_modules_2flocalization_2fproto_2flocalization_5fconfig_2eproto);
namespace apollo {
namespace localization {
