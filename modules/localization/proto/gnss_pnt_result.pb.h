...
class SatDirCosine final :
 ...
 public:
  ...
  explicit constexpr SatDirCosine(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class GnssPntResult final :
 ...
 public:
  ...
  explicit constexpr GnssPntResult(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
