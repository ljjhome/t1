...
class MsfSensorMsgStatus final :
 ...
 public:
  ...
  explicit constexpr MsfSensorMsgStatus(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class MsfStatus final :
 ...
 public:
  ...
  ~MsfStatus() override;
  explicit constexpr MsfStatus(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
