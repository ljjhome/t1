...
class CanbusConf final :
 ...
 public:
  ...
  ~CanbusConf() override;
  explicit constexpr CanbusConf(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::canbus::VehicleParameter* release_vehicle_parameter();
