...
class InputDebug final :
 ...
 public:
  ...
  ~InputDebug() override;
  explicit constexpr InputDebug(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::common::Header* release_localization_header();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::common::Header* release_canbus_header();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::common::Header* release_trajectory_header();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::common::Header* release_latest_replan_trajectory_header();
