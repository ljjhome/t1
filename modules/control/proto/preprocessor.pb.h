...
class Preprocessor final :
 ...
 public:
  ...
  explicit constexpr Preprocessor(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_estop_reason();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::control::LocalView* release_local_view();
...
void Preprocessor::set_estop_reason(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 estop_reason_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Preprocessor::_internal_set_estop_reason(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  estop_reason_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* Preprocessor::_internal_mutable_estop_reason() {
  _has_bits_[0] |= 0x00000001u;
  return estop_reason_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* Preprocessor::release_estop_reason() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return estop_reason_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
