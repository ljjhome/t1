...
class ControlConf final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::control::LatControllerConf* release_lat_controller_conf();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::control::LonControllerConf* release_lon_controller_conf();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::control::MPCControllerConf* release_mpc_controller_conf();
