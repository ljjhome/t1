...
class LatControllerConf final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::control::LeadlagConf* release_reverse_leadlag_conf();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::control::MracConf* release_steer_mrac_conf();
