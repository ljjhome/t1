...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fcontrol_2fproto_2flocal_5fview_2eproto = {
  false, false, 506, descriptor_table_protodef_modules_2fcontrol_2fproto_2flocal_5fview_2eproto, "modules/control/proto/local_view.proto", 
  ...
  file_level_metadata_modules_2fcontrol_2fproto_2flocal_5fview_2eproto, file_level_enum_descriptors_modules_2fcontrol_2fproto_2flocal_5fview_2eproto, file_level_service_descriptors_modules_2fcontrol_2fproto_2flocal_5fview_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_modules_2fcontrol_2fproto_2flocal_5fview_2eproto_getter() {
  return &descriptor_table_modules_2fcontrol_2fproto_2flocal_5fview_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_modules_2fcontrol_2fproto_2flocal_5fview_2eproto(&descriptor_table_modules_2fcontrol_2fproto_2flocal_5fview_2eproto);
namespace apollo {
namespace control {
