...
class MPCControllerConf final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::control::GainScheduler* release_lat_err_gain_scheduler();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::control::GainScheduler* release_heading_err_gain_scheduler();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::control::GainScheduler* release_steer_weight_gain_scheduler();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::control::GainScheduler* release_feedforwardterm_gain_scheduler();
