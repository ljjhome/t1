...
class FnnVehicleModel final :
 ...
 public:
  ...
  explicit constexpr FnnVehicleModel(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::prediction::Vector* release_samples_mean();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::prediction::Vector* release_samples_std();
