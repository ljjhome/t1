...
constexpr VerificationSample::VerificationSample(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : features_()
  , probability_(0)
  , distance_(0){}
struct VerificationSampleDefaultTypeInternal {
  constexpr VerificationSampleDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT VerificationSampleDefaultTypeInternal _VerificationSample_default_instance_;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fprediction_2fproto_2fnetwork_5fmodel_2eproto = {
  false, false, 532, descriptor_table_protodef_modules_2fprediction_2fproto_2fnetwork_5fmodel_2eproto, "modules/prediction/proto/network_model.proto", 
  ...
  file_level_metadata_modules_2fprediction_2fproto_2fnetwork_5fmodel_2eproto, file_level_enum_descriptors_modules_2fprediction_2fproto_2fnetwork_5fmodel_2eproto, file_level_service_descriptors_modules_2fprediction_2fproto_2fnetwork_5fmodel_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_modules_2fprediction_2fproto_2fnetwork_5fmodel_2eproto_getter() {
  return &descriptor_table_modules_2fprediction_2fproto_2fnetwork_5fmodel_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_modules_2fprediction_2fproto_2fnetwork_5fmodel_2eproto(&descriptor_table_modules_2fprediction_2fproto_2fnetwork_5fmodel_2eproto);
namespace apollo {
namespace prediction {
