...
constexpr BatchNormalizationParameter::BatchNormalizationParameter(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : mu_(nullptr)
  , sigma_(nullptr)
  , gamma_(nullptr)
...
struct BatchNormalizationParameterDefaultTypeInternal {
  constexpr BatchNormalizationParameterDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT BatchNormalizationParameterDefaultTypeInternal _BatchNormalizationParameter_default_instance_;
constexpr LSTMParameter::LSTMParameter(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : activation_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , recurrent_activation_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
...
struct LSTMParameterDefaultTypeInternal {
  constexpr LSTMParameterDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT LSTMParameterDefaultTypeInternal _LSTMParameter_default_instance_;
...
constexpr ConcatenateParameter::ConcatenateParameter(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : axis_(0){}
struct ConcatenateParameterDefaultTypeInternal {
  constexpr ConcatenateParameterDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT ConcatenateParameterDefaultTypeInternal _ConcatenateParameter_default_instance_;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fprediction_2fproto_2fnetwork_5flayers_2eproto = {
  false, false, 2741, descriptor_table_protodef_modules_2fprediction_2fproto_2fnetwork_5flayers_2eproto, "modules/prediction/proto/network_layers.proto", 
  ...
  file_level_metadata_modules_2fprediction_2fproto_2fnetwork_5flayers_2eproto, file_level_enum_descriptors_modules_2fprediction_2fproto_2fnetwork_5flayers_2eproto, file_level_service_descriptors_modules_2fprediction_2fproto_2fnetwork_5flayers_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_modules_2fprediction_2fproto_2fnetwork_5flayers_2eproto_getter() {
  return &descriptor_table_modules_2fprediction_2fproto_2fnetwork_5flayers_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_modules_2fprediction_2fproto_2fnetwork_5flayers_2eproto(&descriptor_table_modules_2fprediction_2fproto_2fnetwork_5flayers_2eproto);
namespace apollo {
namespace prediction {
...
// @@protoc_insertion_point(message_byte_size_start:apollo.prediction.LSTMParameter)
  ...
  if (cached_has_bits & 0x003f0000u) {
    ...
    // optional int32 implementation = 10 [default = 0];
    if (cached_has_bits & 0x00100000u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_implementation());
    }
...
void LSTMParameter::InternalSwap(LSTMParameter* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &recurrent_activation_, lhs_arena,
      &other->recurrent_activation_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
...
void LayerParameter::set_allocated_input(::apollo::prediction::InputParameter* input) {
  ...
  if (input) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::apollo::prediction::InputParameter>::GetOwningArena(input);
...
void LayerParameter::set_allocated_activation(::apollo::prediction::ActivationParameter* activation) {
  ...
  if (activation) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::apollo::prediction::ActivationParameter>::GetOwningArena(activation);
    if (message_arena != submessage_arena) {
...
void LayerParameter::set_allocated_dense(::apollo::prediction::DenseParameter* dense) {
  ...
  if (dense) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::apollo::prediction::DenseParameter>::GetOwningArena(dense);
    if (message_arena != submessage_arena) {
...
void LayerParameter::set_allocated_batch_normalization(::apollo::prediction::BatchNormalizationParameter* batch_normalization) {
  ...
  if (batch_normalization) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::apollo::prediction::BatchNormalizationParameter>::GetOwningArena(batch_normalization);
    if (message_arena != submessage_arena) {
...
void LayerParameter::set_allocated_lstm(::apollo::prediction::LSTMParameter* lstm) {
  ...
  if (lstm) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::apollo::prediction::LSTMParameter>::GetOwningArena(lstm);
    if (message_arena != submessage_arena) {
...
void LayerParameter::set_allocated_flatten(::apollo::prediction::FlattenParameter* flatten) {
  ...
  if (flatten) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::apollo::prediction::FlattenParameter>::GetOwningArena(flatten);
    if (message_arena != submessage_arena) {
...
void LayerParameter::set_allocated_concatenate(::apollo::prediction::ConcatenateParameter* concatenate) {
  ...
  if (concatenate) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::apollo::prediction::ConcatenateParameter>::GetOwningArena(concatenate);
    if (message_arena != submessage_arena) {
...
void LayerParameter::set_allocated_conv1d(::apollo::prediction::Conv1dParameter* conv1d) {
  ...
  if (conv1d) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::apollo::prediction::Conv1dParameter>::GetOwningArena(conv1d);
    if (message_arena != submessage_arena) {
...
void LayerParameter::set_allocated_maxpool1d(::apollo::prediction::MaxPool1dParameter* maxpool1d) {
  ...
  if (maxpool1d) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::apollo::prediction::MaxPool1dParameter>::GetOwningArena(maxpool1d);
    if (message_arena != submessage_arena) {
...
void LayerParameter::set_allocated_avgpool1d(::apollo::prediction::AvgPool1dParameter* avgpool1d) {
  ...
  if (avgpool1d) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::apollo::prediction::AvgPool1dParameter>::GetOwningArena(avgpool1d);
    if (message_arena != submessage_arena) {
...
// @@protoc_insertion_point(message_byte_size_start:apollo.prediction.LayerParameter)
  ...
  if (cached_has_bits & 0x00000007u) {
    ...
    // optional int32 order_number = 3;
    if (cached_has_bits & 0x00000004u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_order_number());
    }
