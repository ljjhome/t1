...
class VerificationSample final :
 ...
 public:
  ...
  explicit constexpr VerificationSample(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class NetParameter final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::prediction::Performance* release_performance();
...
inline void NetParameter::set_allocated_performance(::apollo::prediction::Performance* performance) {
  ...
  if (performance) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::apollo::prediction::Performance>::GetOwningArena(performance);
