...
class Layer final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::prediction::Matrix* release_layer_input_weight();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::prediction::Vector* release_layer_bias();
...
inline void Layer::set_allocated_layer_input_weight(::apollo::prediction::Matrix* layer_input_weight) {
  ...
  if (layer_input_weight) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::apollo::prediction::Matrix>::GetOwningArena(layer_input_weight);
...
inline void Layer::set_allocated_layer_bias(::apollo::prediction::Vector* layer_bias) {
  ...
  if (layer_bias) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::apollo::prediction::Vector>::GetOwningArena(layer_bias);
    if (message_arena != submessage_arena) {
