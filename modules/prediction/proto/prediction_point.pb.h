...
class PredictionTrajectoryPoint final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::prediction::PredictionPathPoint* release_path_point();
...
inline void PredictionTrajectoryPoint::set_allocated_path_point(::apollo::prediction::PredictionPathPoint* path_point) {
  ...
  if (path_point) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::apollo::prediction::PredictionPathPoint>::GetOwningArena(path_point);
