...
namespace drivers {
namespace canbus {
constexpr CANCardParameter::CANCardParameter(
...
struct CANCardParameterDefaultTypeInternal {
  constexpr CANCardParameterDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT CANCardParameterDefaultTypeInternal _CANCardParameter_default_instance_;
}  // namespace canbus
}  // namespace drivers
}  // namespace apollo
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fdrivers_2fcanbus_2fproto_2fcan_5fcard_5fparameter_2eproto = {
  false, false, 762, descriptor_table_protodef_modules_2fdrivers_2fcanbus_2fproto_2fcan_5fcard_5fparameter_2eproto, "modules/drivers/canbus/proto/can_card_parameter.proto", 
  ...
  file_level_metadata_modules_2fdrivers_2fcanbus_2fproto_2fcan_5fcard_5fparameter_2eproto, file_level_enum_descriptors_modules_2fdrivers_2fcanbus_2fproto_2fcan_5fcard_5fparameter_2eproto, file_level_service_descriptors_modules_2fdrivers_2fcanbus_2fproto_2fcan_5fcard_5fparameter_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_modules_2fdrivers_2fcanbus_2fproto_2fcan_5fcard_5fparameter_2eproto_getter() {
  return &descriptor_table_modules_2fdrivers_2fcanbus_2fproto_2fcan_5fcard_5fparameter_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_modules_2fdrivers_2fcanbus_2fproto_2fcan_5fcard_5fparameter_2eproto(&descriptor_table_modules_2fdrivers_2fcanbus_2fproto_2fcan_5fcard_5fparameter_2eproto);
namespace apollo {
namespace drivers {
namespace canbus {
...
// @@protoc_insertion_point(message_byte_size_start:apollo.drivers.canbus.CANCardParameter)
  ...
  if (cached_has_bits & 0x0000001fu) {
    ...
    // optional uint32 num_ports = 5 [default = 4];
    if (cached_has_bits & 0x00000010u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_num_ports());
    }
