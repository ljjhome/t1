...
class CanConf final :
 ...
 public:
  ...
  ~CanConf() override;
  explicit constexpr CanConf(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::drivers::canbus::CANCardParameter* release_can_card_parameter();
...
class RadarConf final :
 ...
 public:
  ...
  ~RadarConf() override;
  explicit constexpr RadarConf(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class ContiRadarConf final :
 ...
 public:
  ...
  explicit constexpr ContiRadarConf(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_radar_channel();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::drivers::conti_radar::CanConf* release_can_conf();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::drivers::conti_radar::RadarConf* release_radar_conf();
...
inline void ContiRadarConf::set_allocated_can_conf(::apollo::drivers::conti_radar::CanConf* can_conf) {
  ...
  if (can_conf) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::apollo::drivers::conti_radar::CanConf>::GetOwningArena(can_conf);
    if (message_arena != submessage_arena) {
...
inline void ContiRadarConf::set_allocated_radar_conf(::apollo::drivers::conti_radar::RadarConf* radar_conf) {
  ...
  if (radar_conf) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::apollo::drivers::conti_radar::RadarConf>::GetOwningArena(radar_conf);
    if (message_arena != submessage_arena) {
...
void ContiRadarConf::set_radar_channel(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 radar_channel_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void ContiRadarConf::_internal_set_radar_channel(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  radar_channel_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* ContiRadarConf::_internal_mutable_radar_channel() {
  _has_bits_[0] |= 0x00000001u;
  return radar_channel_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* ContiRadarConf::release_radar_channel() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return radar_channel_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
