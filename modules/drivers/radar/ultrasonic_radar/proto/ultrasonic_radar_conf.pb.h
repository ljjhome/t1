...
class UltrasonicRadarConf final :
 ...
 public:
  ...
  explicit constexpr UltrasonicRadarConf(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline UltrasonicRadarConf* New() const final {
    return new UltrasonicRadarConf();
  }
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::drivers::ultrasonic_radar::CanConf* release_can_conf();
...
inline void UltrasonicRadarConf::set_allocated_can_conf(::apollo::drivers::ultrasonic_radar::CanConf* can_conf) {
  ...
  if (can_conf) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::apollo::drivers::ultrasonic_radar::CanConf>::GetOwningArena(can_conf);
    if (message_arena != submessage_arena) {
