...
class RacobitRadarConf final :
 ...
 public:
  ...
  explicit constexpr RacobitRadarConf(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::drivers::racobit_radar::CanConf* release_can_conf();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::drivers::racobit_radar::RadarConf* release_radar_conf();
...
inline void RacobitRadarConf::set_allocated_can_conf(::apollo::drivers::racobit_radar::CanConf* can_conf) {
  ...
  if (can_conf) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::apollo::drivers::racobit_radar::CanConf>::GetOwningArena(can_conf);
    if (message_arena != submessage_arena) {
...
inline void RacobitRadarConf::set_allocated_radar_conf(::apollo::drivers::racobit_radar::RadarConf* radar_conf) {
  ...
  if (radar_conf) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::apollo::drivers::racobit_radar::RadarConf>::GetOwningArena(radar_conf);
    if (message_arena != submessage_arena) {
