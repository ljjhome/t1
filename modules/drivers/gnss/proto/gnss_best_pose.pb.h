...
class GnssBestPose final :
 ...
 public:
  ...
  explicit constexpr GnssBestPose(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_base_station_id();
...
void GnssBestPose::set_base_station_id(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 base_station_id_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void GnssBestPose::_internal_set_base_station_id(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  base_station_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* GnssBestPose::_internal_mutable_base_station_id() {
  _has_bits_[0] |= 0x00000001u;
  return base_station_id_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* GnssBestPose::release_base_station_id() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return base_station_id_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
