...
namespace drivers {
namespace gnss {
constexpr InsStat::InsStat(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : header_(nullptr)
  , ins_status_(0u)
  , pos_type_(0u){}
struct InsStatDefaultTypeInternal {
  constexpr InsStatDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT InsStatDefaultTypeInternal _InsStat_default_instance_;
constexpr Ins::Ins(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : position_covariance_()
  , euler_angles_covariance_()
  , linear_velocity_covariance_()
...
struct InsDefaultTypeInternal {
  constexpr InsDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT InsDefaultTypeInternal _Ins_default_instance_;
}  // namespace gnss
}  // namespace drivers
}  // namespace apollo
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fdrivers_2fgnss_2fproto_2fins_2eproto = {
  false, false, 820, descriptor_table_protodef_modules_2fdrivers_2fgnss_2fproto_2fins_2eproto, "modules/drivers/gnss/proto/ins.proto", 
  ...
  file_level_metadata_modules_2fdrivers_2fgnss_2fproto_2fins_2eproto, file_level_enum_descriptors_modules_2fdrivers_2fgnss_2fproto_2fins_2eproto, file_level_service_descriptors_modules_2fdrivers_2fgnss_2fproto_2fins_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_modules_2fdrivers_2fgnss_2fproto_2fins_2eproto_getter() {
  return &descriptor_table_modules_2fdrivers_2fgnss_2fproto_2fins_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_modules_2fdrivers_2fgnss_2fproto_2fins_2eproto(&descriptor_table_modules_2fdrivers_2fgnss_2fproto_2fins_2eproto);
namespace apollo {
namespace drivers {
namespace gnss {
...
// @@protoc_insertion_point(message_byte_size_start:apollo.drivers.gnss.InsStat)
  ...
  if (cached_has_bits & 0x00000007u) {
    ...
    // optional uint32 ins_status = 2;
    if (cached_has_bits & 0x00000002u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_ins_status());
    }

    // optional uint32 pos_type = 3;
    if (cached_has_bits & 0x00000004u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_pos_type());
    }
