...
struct GnssDefaultTypeInternal {
  constexpr GnssDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT GnssDefaultTypeInternal _Gnss_default_instance_;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fdrivers_2fgnss_2fproto_2fgnss_2eproto = {
  false, false, 713, descriptor_table_protodef_modules_2fdrivers_2fgnss_2fproto_2fgnss_2eproto, "modules/drivers/gnss/proto/gnss.proto", 
  ...
  file_level_metadata_modules_2fdrivers_2fgnss_2fproto_2fgnss_2eproto, file_level_enum_descriptors_modules_2fdrivers_2fgnss_2fproto_2fgnss_2eproto, file_level_service_descriptors_modules_2fdrivers_2fgnss_2fproto_2fgnss_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_modules_2fdrivers_2fgnss_2fproto_2fgnss_2eproto_getter() {
  return &descriptor_table_modules_2fdrivers_2fgnss_2fproto_2fgnss_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_modules_2fdrivers_2fgnss_2fproto_2fgnss_2eproto(&descriptor_table_modules_2fdrivers_2fgnss_2fproto_2fgnss_2eproto);
namespace apollo {
namespace drivers {
namespace gnss {
