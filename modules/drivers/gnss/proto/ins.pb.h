...
class InsStat final :
 ...
 public:
  ...
  ~InsStat() override;
  explicit constexpr InsStat(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class Ins final :
 ...
 public:
  ...
  ~Ins() override;
  explicit constexpr Ins(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::common::PointLLH* release_position();
