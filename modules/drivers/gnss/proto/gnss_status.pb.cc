...
namespace drivers {
namespace gnss {
constexpr StreamStatus::StreamStatus(
...
struct StreamStatusDefaultTypeInternal {
  constexpr StreamStatusDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT StreamStatusDefaultTypeInternal _StreamStatus_default_instance_;
constexpr InsStatus::InsStatus(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : header_(nullptr)
  , type_(0)
{}
struct InsStatusDefaultTypeInternal {
  constexpr InsStatusDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT InsStatusDefaultTypeInternal _InsStatus_default_instance_;
constexpr GnssStatus::GnssStatus(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : header_(nullptr)
...
struct GnssStatusDefaultTypeInternal {
  constexpr GnssStatusDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT GnssStatusDefaultTypeInternal _GnssStatus_default_instance_;
}  // namespace gnss
}  // namespace drivers
}  // namespace apollo
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fdrivers_2fgnss_2fproto_2fgnss_5fstatus_2eproto = {
  false, false, 767, descriptor_table_protodef_modules_2fdrivers_2fgnss_2fproto_2fgnss_5fstatus_2eproto, "modules/drivers/gnss/proto/gnss_status.proto", 
  ...
  file_level_metadata_modules_2fdrivers_2fgnss_2fproto_2fgnss_5fstatus_2eproto, file_level_enum_descriptors_modules_2fdrivers_2fgnss_2fproto_2fgnss_5fstatus_2eproto, file_level_service_descriptors_modules_2fdrivers_2fgnss_2fproto_2fgnss_5fstatus_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_modules_2fdrivers_2fgnss_2fproto_2fgnss_5fstatus_2eproto_getter() {
  return &descriptor_table_modules_2fdrivers_2fgnss_2fproto_2fgnss_5fstatus_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_modules_2fdrivers_2fgnss_2fproto_2fgnss_5fstatus_2eproto(&descriptor_table_modules_2fdrivers_2fgnss_2fproto_2fgnss_5fstatus_2eproto);
namespace apollo {
namespace drivers {
namespace gnss {
...
// @@protoc_insertion_point(message_byte_size_start:apollo.drivers.gnss.GnssStatus)
  ...
  if (cached_has_bits & 0x0000001fu) {
    ...
    // optional uint32 solution_status = 3 [default = 0];
    if (cached_has_bits & 0x00000004u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_solution_status());
    }

    // optional uint32 position_type = 4 [default = 0];
    if (cached_has_bits & 0x00000008u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_position_type());
    }

    // optional int32 num_sats = 5 [default = 0];
    if (cached_has_bits & 0x00000010u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_num_sats());
    }
