...
namespace drivers {
namespace gnss {
constexpr GnssBestPose::GnssBestPose(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : base_station_id_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , header_(nullptr)
  , measurement_time_(0)
  , sol_status_(0)
...
struct GnssBestPoseDefaultTypeInternal {
  constexpr GnssBestPoseDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT GnssBestPoseDefaultTypeInternal _GnssBestPose_default_instance_;
}  // namespace gnss
}  // namespace drivers
}  // namespace apollo
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fdrivers_2fgnss_2fproto_2fgnss_5fbest_5fpose_2eproto = {
  false, false, 1633, descriptor_table_protodef_modules_2fdrivers_2fgnss_2fproto_2fgnss_5fbest_5fpose_2eproto, "modules/drivers/gnss/proto/gnss_best_pose.proto", 
  ...
  file_level_metadata_modules_2fdrivers_2fgnss_2fproto_2fgnss_5fbest_5fpose_2eproto, file_level_enum_descriptors_modules_2fdrivers_2fgnss_2fproto_2fgnss_5fbest_5fpose_2eproto, file_level_service_descriptors_modules_2fdrivers_2fgnss_2fproto_2fgnss_5fbest_5fpose_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_modules_2fdrivers_2fgnss_2fproto_2fgnss_5fbest_5fpose_2eproto_getter() {
  return &descriptor_table_modules_2fdrivers_2fgnss_2fproto_2fgnss_5fbest_5fpose_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_modules_2fdrivers_2fgnss_2fproto_2fgnss_5fbest_5fpose_2eproto(&descriptor_table_modules_2fdrivers_2fgnss_2fproto_2fgnss_5fbest_5fpose_2eproto);
namespace apollo {
namespace drivers {
namespace gnss {
...
void GnssBestPose::InternalSwap(GnssBestPose* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      ...
      &base_station_id_, lhs_arena,
      &other->base_station_id_, rhs_arena
  );
