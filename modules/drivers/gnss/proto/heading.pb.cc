...
constexpr Heading::Heading(
  ...
  : station_id_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , header_(nullptr)
  , measurement_time_(0)
  , solution_status_(0u)
  , position_type_(0u)
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fdrivers_2fgnss_2fproto_2fheading_2eproto = {
  false, false, 620, descriptor_table_protodef_modules_2fdrivers_2fgnss_2fproto_2fheading_2eproto, "modules/drivers/gnss/proto/heading.proto", 
  ...
  file_level_metadata_modules_2fdrivers_2fgnss_2fproto_2fheading_2eproto, file_level_enum_descriptors_modules_2fdrivers_2fgnss_2fproto_2fheading_2eproto, file_level_service_descriptors_modules_2fdrivers_2fgnss_2fproto_2fheading_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_modules_2fdrivers_2fgnss_2fproto_2fheading_2eproto_getter() {
  return &descriptor_table_modules_2fdrivers_2fgnss_2fproto_2fheading_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_modules_2fdrivers_2fgnss_2fproto_2fheading_2eproto(&descriptor_table_modules_2fdrivers_2fgnss_2fproto_2fheading_2eproto);
namespace apollo {
namespace drivers {
namespace gnss {
...
// @@protoc_insertion_point(message_byte_size_start:apollo.drivers.gnss.Heading)
  ...
  if (cached_has_bits & 0x0000ff00u) {
    ...
    // optional uint32 satellite_tracked_number = 12;
    if (cached_has_bits & 0x00000800u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_satellite_tracked_number());
    }

    // optional uint32 satellite_soulution_number = 13;
    if (cached_has_bits & 0x00001000u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_satellite_soulution_number());
    }

    // optional uint32 satellite_number_obs = 14;
    if (cached_has_bits & 0x00002000u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_satellite_number_obs());
    }

    // optional uint32 satellite_number_multi = 15;
    if (cached_has_bits & 0x00004000u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_satellite_number_multi());
    }
...
void Heading::InternalSwap(Heading* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      ...
      &station_id_, lhs_arena,
      &other->station_id_, rhs_arena
  );
