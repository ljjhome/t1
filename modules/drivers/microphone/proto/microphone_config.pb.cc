...
namespace config {
constexpr MicrophoneConfig::MicrophoneConfig(
...
struct MicrophoneConfigDefaultTypeInternal {
  constexpr MicrophoneConfigDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT MicrophoneConfigDefaultTypeInternal _MicrophoneConfig_default_instance_;
}  // namespace config
}  // namespace microphone
}  // namespace drivers
}  // namespace apollo
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fdrivers_2fmicrophone_2fproto_2fmicrophone_5fconfig_2eproto = {
  false, false, 527, descriptor_table_protodef_modules_2fdrivers_2fmicrophone_2fproto_2fmicrophone_5fconfig_2eproto, "modules/drivers/microphone/proto/microphone_config.proto", 
  ...
  file_level_metadata_modules_2fdrivers_2fmicrophone_2fproto_2fmicrophone_5fconfig_2eproto, file_level_enum_descriptors_modules_2fdrivers_2fmicrophone_2fproto_2fmicrophone_5fconfig_2eproto, file_level_service_descriptors_modules_2fdrivers_2fmicrophone_2fproto_2fmicrophone_5fconfig_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_modules_2fdrivers_2fmicrophone_2fproto_2fmicrophone_5fconfig_2eproto_getter() {
  return &descriptor_table_modules_2fdrivers_2fmicrophone_2fproto_2fmicrophone_5fconfig_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_modules_2fdrivers_2fmicrophone_2fproto_2fmicrophone_5fconfig_2eproto(&descriptor_table_modules_2fdrivers_2fmicrophone_2fproto_2fmicrophone_5fconfig_2eproto);
namespace apollo {
namespace drivers {
namespace microphone {
namespace config {
...
// @@protoc_insertion_point(message_byte_size_start:apollo.drivers.microphone.config.MicrophoneConfig)
  ...
  if (cached_has_bits & 0x000000ffu) {
    ...
    // optional int32 chunk = 3;
    if (cached_has_bits & 0x00000008u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_chunk());
    }
    ...
    // optional int32 sample_width = 6;
    if (cached_has_bits & 0x00000040u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_sample_width());
    }
