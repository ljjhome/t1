...
namespace apollo {
namespace drivers {
constexpr PointXYZIT::PointXYZIT(
...
struct PointXYZITDefaultTypeInternal {
  constexpr PointXYZITDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PointXYZITDefaultTypeInternal _PointXYZIT_default_instance_;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fdrivers_2fproto_2fpointcloud_2eproto = {
  false, false, 387, descriptor_table_protodef_modules_2fdrivers_2fproto_2fpointcloud_2eproto, "modules/drivers/proto/pointcloud.proto", 
  ...
  file_level_metadata_modules_2fdrivers_2fproto_2fpointcloud_2eproto, file_level_enum_descriptors_modules_2fdrivers_2fproto_2fpointcloud_2eproto, file_level_service_descriptors_modules_2fdrivers_2fproto_2fpointcloud_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_modules_2fdrivers_2fproto_2fpointcloud_2eproto_getter() {
  return &descriptor_table_modules_2fdrivers_2fproto_2fpointcloud_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_modules_2fdrivers_2fproto_2fpointcloud_2eproto(&descriptor_table_modules_2fdrivers_2fproto_2fpointcloud_2eproto);
namespace apollo {
namespace drivers {
...
// @@protoc_insertion_point(message_byte_size_start:apollo.drivers.PointXYZIT)
  ...
  if (cached_has_bits & 0x0000001fu) {
    ...
    // optional uint32 intensity = 4 [default = 0];
    if (cached_has_bits & 0x00000002u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_intensity());
    }
