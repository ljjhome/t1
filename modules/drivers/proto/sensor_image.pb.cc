...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fdrivers_2fproto_2fsensor_5fimage_2eproto = {
  false, false, 1182, descriptor_table_protodef_modules_2fdrivers_2fproto_2fsensor_5fimage_2eproto, "modules/drivers/proto/sensor_image.proto", 
  ...
  file_level_metadata_modules_2fdrivers_2fproto_2fsensor_5fimage_2eproto, file_level_enum_descriptors_modules_2fdrivers_2fproto_2fsensor_5fimage_2eproto, file_level_service_descriptors_modules_2fdrivers_2fproto_2fsensor_5fimage_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_modules_2fdrivers_2fproto_2fsensor_5fimage_2eproto_getter() {
  return &descriptor_table_modules_2fdrivers_2fproto_2fsensor_5fimage_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_modules_2fdrivers_2fproto_2fsensor_5fimage_2eproto(&descriptor_table_modules_2fdrivers_2fproto_2fsensor_5fimage_2eproto);
namespace apollo {
namespace drivers {
...
// @@protoc_insertion_point(message_byte_size_start:apollo.drivers.CompressedImage)
  ...
  if (cached_has_bits & 0x0000003fu) {
    ...
    // optional uint32 frame_type = 6;
    if (cached_has_bits & 0x00000020u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_frame_type());
    }
