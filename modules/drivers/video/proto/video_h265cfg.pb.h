...
class CameraH265Config_CompressConfig final :
 ...
 public:
  ...
  explicit constexpr CameraH265Config_CompressConfig(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline CameraH265Config_CompressConfig* New() const final {
    return new CameraH265Config_CompressConfig();
  }
...
class CameraH265Config final :
 ...
 public:
  ...
  explicit constexpr CameraH265Config(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_trigger_param();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::drivers::video::config::CameraH265Config_CompressConfig* release_compress_conf();
...
inline void CameraH265Config::clear_pixel_format() {
  pixel_format_.ClearToDefault(::apollo::drivers::video::config::CameraH265Config::_i_give_permission_to_break_this_code_default_pixel_format_, GetArenaForAllocation());
  _has_bits_[0] &= ~0x00000002u;
}
...
inline std::string* CameraH265Config::_internal_mutable_pixel_format() {
  _has_bits_[0] |= 0x00000002u;
  return pixel_format_.Mutable(::apollo::drivers::video::config::CameraH265Config::_i_give_permission_to_break_this_code_default_pixel_format_, GetArenaForAllocation());
}
...
inline void CameraH265Config::clear_trigger_param() {
  trigger_param_.ClearToDefault(::apollo::drivers::video::config::CameraH265Config::_i_give_permission_to_break_this_code_default_trigger_param_, GetArenaForAllocation());
...
void CameraH265Config::set_trigger_param(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000004u;
 trigger_param_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void CameraH265Config::_internal_set_trigger_param(const std::string& value) {
  _has_bits_[0] |= 0x00000004u;
  trigger_param_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* CameraH265Config::_internal_mutable_trigger_param() {
  _has_bits_[0] |= 0x00000004u;
  return trigger_param_.Mutable(::apollo::drivers::video::config::CameraH265Config::_i_give_permission_to_break_this_code_default_trigger_param_, GetArenaForAllocation());
}
inline std::string* CameraH265Config::release_trigger_param() {
  ...
  _has_bits_[0] &= ~0x00000004u;
  return trigger_param_.ReleaseNonDefault(nullptr, GetArenaForAllocation());
}
...
inline void CameraH265Config::set_allocated_compress_conf(::apollo::drivers::video::config::CameraH265Config_CompressConfig* compress_conf) {
  ...
  if (compress_conf) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::apollo::drivers::video::config::CameraH265Config_CompressConfig>::GetOwningArena(compress_conf);
