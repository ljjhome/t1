...
void Config::set_ip(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 ip_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Config::_internal_set_ip(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  ip_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* Config::_internal_mutable_ip() {
  _has_bits_[0] |= 0x00000001u;
  return ip_.Mutable(::apollo::drivers::hesai::Config::_i_give_permission_to_break_this_code_default_ip_, GetArenaForAllocation());
}
inline std::string* Config::release_ip() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return ip_.ReleaseNonDefault(nullptr, GetArenaForAllocation());
}
