...
class config final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::drivers::hesai::Config* release_hesai();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::drivers::robosense::Config* release_robosense();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::drivers::velodyne::Config* release_velodyne();
