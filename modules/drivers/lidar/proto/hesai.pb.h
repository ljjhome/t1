...
class HesaiScanPacket final :
 ...
 public:
  ...
  explicit constexpr HesaiScanPacket(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class HesaiScan final :
 ...
 public:
  ...
  ~HesaiScan() override;
  explicit constexpr HesaiScan(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
