...
namespace drivers {
namespace velodyne {
constexpr VelodynePacket::VelodynePacket(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : data_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , stamp_(uint64_t{0u}){}
struct VelodynePacketDefaultTypeInternal {
  constexpr VelodynePacketDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT VelodynePacketDefaultTypeInternal _VelodynePacket_default_instance_;
constexpr VelodyneScan::VelodyneScan(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : firing_pkts_()
  , positioning_pkts_()
  , sn_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , header_(nullptr)
...
struct VelodyneScanDefaultTypeInternal {
  constexpr VelodyneScanDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT VelodyneScanDefaultTypeInternal _VelodyneScan_default_instance_;
}  // namespace velodyne
}  // namespace drivers
}  // namespace apollo
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fdrivers_2flidar_2fproto_2fvelodyne_2eproto = {
  false, false, 620, descriptor_table_protodef_modules_2fdrivers_2flidar_2fproto_2fvelodyne_2eproto, "modules/drivers/lidar/proto/velodyne.proto", 
  ...
  file_level_metadata_modules_2fdrivers_2flidar_2fproto_2fvelodyne_2eproto, file_level_enum_descriptors_modules_2fdrivers_2flidar_2fproto_2fvelodyne_2eproto, file_level_service_descriptors_modules_2fdrivers_2flidar_2fproto_2fvelodyne_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_modules_2fdrivers_2flidar_2fproto_2fvelodyne_2eproto_getter() {
  return &descriptor_table_modules_2fdrivers_2flidar_2fproto_2fvelodyne_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_modules_2fdrivers_2flidar_2fproto_2fvelodyne_2eproto(&descriptor_table_modules_2fdrivers_2flidar_2fproto_2fvelodyne_2eproto);
namespace apollo {
namespace drivers {
namespace velodyne {
