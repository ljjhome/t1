...
class VelodynePacket final :
 ...
 public:
  ...
  explicit constexpr VelodynePacket(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class VelodyneScan final :
 ...
 public:
  ...
  explicit constexpr VelodyneScan(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_sn();
...
void VelodyneScan::set_sn(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 sn_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void VelodyneScan::_internal_set_sn(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  sn_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* VelodyneScan::_internal_mutable_sn() {
  _has_bits_[0] |= 0x00000001u;
  return sn_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* VelodyneScan::release_sn() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return sn_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
