...
namespace common {
namespace adapter {
constexpr AdapterConfig::AdapterConfig(
...
struct AdapterConfigDefaultTypeInternal {
  constexpr AdapterConfigDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT AdapterConfigDefaultTypeInternal _AdapterConfig_default_instance_;
constexpr AdapterManagerConfig::AdapterManagerConfig(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : config_()
  , is_ros_(false){}
struct AdapterManagerConfigDefaultTypeInternal {
  constexpr AdapterManagerConfigDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT AdapterManagerConfigDefaultTypeInternal _AdapterManagerConfig_default_instance_;
}  // namespace adapter
}  // namespace common
}  // namespace apollo
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fcommon_2fadapters_2fproto_2fadapter_5fconfig_2eproto = {
  false, false, 2013, descriptor_table_protodef_modules_2fcommon_2fadapters_2fproto_2fadapter_5fconfig_2eproto, "modules/common/adapters/proto/adapter_config.proto", 
  ...
  file_level_metadata_modules_2fcommon_2fadapters_2fproto_2fadapter_5fconfig_2eproto, file_level_enum_descriptors_modules_2fcommon_2fadapters_2fproto_2fadapter_5fconfig_2eproto, file_level_service_descriptors_modules_2fcommon_2fadapters_2fproto_2fadapter_5fconfig_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_modules_2fcommon_2fadapters_2fproto_2fadapter_5fconfig_2eproto_getter() {
  return &descriptor_table_modules_2fcommon_2fadapters_2fproto_2fadapter_5fconfig_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_modules_2fcommon_2fadapters_2fproto_2fadapter_5fconfig_2eproto(&descriptor_table_modules_2fcommon_2fadapters_2fproto_2fadapter_5fconfig_2eproto);
namespace apollo {
namespace common {
namespace adapter {
...
// @@protoc_insertion_point(message_byte_size_start:apollo.common.adapter.AdapterConfig)
  ...
  if (cached_has_bits & 0x0000001fu) {
    ...
    // optional int32 message_history_limit = 3 [default = 10];
    if (cached_has_bits & 0x00000010u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_message_history_limit());
    }
