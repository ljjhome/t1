...
class AdapterConfig final :
 ...
 public:
  ...
  explicit constexpr AdapterConfig(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class AdapterManagerConfig final :
 ...
 public:
  ...
  explicit constexpr AdapterManagerConfig(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline AdapterManagerConfig* New() const final {
    return new AdapterManagerConfig();
  }
