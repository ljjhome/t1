...
namespace common {
namespace monitor {
constexpr MonitorMessageItem::MonitorMessageItem(
...
struct MonitorMessageItemDefaultTypeInternal {
  constexpr MonitorMessageItemDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT MonitorMessageItemDefaultTypeInternal _MonitorMessageItem_default_instance_;
constexpr MonitorMessage::MonitorMessage(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : item_()
  , header_(nullptr){}
struct MonitorMessageDefaultTypeInternal {
  constexpr MonitorMessageDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT MonitorMessageDefaultTypeInternal _MonitorMessage_default_instance_;
}  // namespace monitor
}  // namespace common
}  // namespace apollo
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fcommon_2fmonitor_5flog_2fproto_2fmonitor_5flog_2eproto = {
  false, false, 804, descriptor_table_protodef_modules_2fcommon_2fmonitor_5flog_2fproto_2fmonitor_5flog_2eproto, "modules/common/monitor_log/proto/monitor_log.proto", 
  ...
  file_level_metadata_modules_2fcommon_2fmonitor_5flog_2fproto_2fmonitor_5flog_2eproto, file_level_enum_descriptors_modules_2fcommon_2fmonitor_5flog_2fproto_2fmonitor_5flog_2eproto, file_level_service_descriptors_modules_2fcommon_2fmonitor_5flog_2fproto_2fmonitor_5flog_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_modules_2fcommon_2fmonitor_5flog_2fproto_2fmonitor_5flog_2eproto_getter() {
  return &descriptor_table_modules_2fcommon_2fmonitor_5flog_2fproto_2fmonitor_5flog_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_modules_2fcommon_2fmonitor_5flog_2fproto_2fmonitor_5flog_2eproto(&descriptor_table_modules_2fcommon_2fmonitor_5flog_2fproto_2fmonitor_5flog_2eproto);
namespace apollo {
namespace common {
namespace monitor {
