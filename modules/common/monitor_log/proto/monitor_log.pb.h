...
class MonitorMessageItem final :
 ...
 public:
  ...
  explicit constexpr MonitorMessageItem(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class MonitorMessage final :
 ...
 public:
  ...
  explicit constexpr MonitorMessage(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
