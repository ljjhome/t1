...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_modules_2fthird_5fparty_5fperception_2fproto_2fradar_5fobstacle_2eproto[3];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_modules_2fthird_5fparty_5fperception_2fproto_2fradar_5fobstacle_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_modules_2fthird_5fparty_5fperception_2fproto_2fradar_5fobstacle_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_modules_2fthird_5fparty_5fperception_2fproto_2fradar_5fobstacle_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::apollo::third_party_perception::RadarObstacle, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::apollo::third_party_perception::RadarObstacle, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::apollo::third_party_perception::RadarObstacle, id_),
  PROTOBUF_FIELD_OFFSET(::apollo::third_party_perception::RadarObstacle, relative_position_),
  PROTOBUF_FIELD_OFFSET(::apollo::third_party_perception::RadarObstacle, relative_velocity_),
  PROTOBUF_FIELD_OFFSET(::apollo::third_party_perception::RadarObstacle, rcs_),
  PROTOBUF_FIELD_OFFSET(::apollo::third_party_perception::RadarObstacle, movable_),
  PROTOBUF_FIELD_OFFSET(::apollo::third_party_perception::RadarObstacle, width_),
  PROTOBUF_FIELD_OFFSET(::apollo::third_party_perception::RadarObstacle, length_),
  PROTOBUF_FIELD_OFFSET(::apollo::third_party_perception::RadarObstacle, height_),
  PROTOBUF_FIELD_OFFSET(::apollo::third_party_perception::RadarObstacle, theta_),
  PROTOBUF_FIELD_OFFSET(::apollo::third_party_perception::RadarObstacle, absolute_position_),
  PROTOBUF_FIELD_OFFSET(::apollo::third_party_perception::RadarObstacle, absolute_velocity_),
  PROTOBUF_FIELD_OFFSET(::apollo::third_party_perception::RadarObstacle, count_),
  PROTOBUF_FIELD_OFFSET(::apollo::third_party_perception::RadarObstacle, moving_frames_count_),
  4,
  0,
  1,
  6,
  ...
  0,
  1,
  PROTOBUF_FIELD_OFFSET(::apollo::third_party_perception::RadarObstacles, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::apollo::third_party_perception::RadarObstacles, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::apollo::third_party_perception::RadarObstacles, radar_obstacle_),
  PROTOBUF_FIELD_OFFSET(::apollo::third_party_perception::RadarObstacles, header_),
  PROTOBUF_FIELD_OFFSET(::apollo::third_party_perception::RadarObstacles, error_code_),
  ~0u,
  0,
  1,
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::apollo::third_party_perception::_RadarObstacle_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::apollo::third_party_perception::_RadarObstacles_RadarObstacleEntry_DoNotUse_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::apollo::third_party_perception::_RadarObstacles_default_instance_),
};
...
const char descriptor_table_protodef_modules_2fthird_5fparty_5fperception_2fproto_2fradar_5fobstacle_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_modules_2fthird_5fparty_5fperception_2fproto_2fradar_5fobstacle_2eproto_deps[3] = {
...
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_modules_2fthird_5fparty_5fperception_2fproto_2fradar_5fobstacle_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fthird_5fparty_5fperception_2fproto_2fradar_5fobstacle_2eproto = {
  false, false, 869, descriptor_table_protodef_modules_2fthird_5fparty_5fperception_2fproto_2fradar_5fobstacle_2eproto, "modules/third_party_perception/proto/radar_obstacle.proto", 
  ...
  file_level_metadata_modules_2fthird_5fparty_5fperception_2fproto_2fradar_5fobstacle_2eproto, file_level_enum_descriptors_modules_2fthird_5fparty_5fperception_2fproto_2fradar_5fobstacle_2eproto, file_level_service_descriptors_modules_2fthird_5fparty_5fperception_2fproto_2fradar_5fobstacle_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_modules_2fthird_5fparty_5fperception_2fproto_2fradar_5fobstacle_2eproto_getter() {
  return &descriptor_table_modules_2fthird_5fparty_5fperception_2fproto_2fradar_5fobstacle_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_modules_2fthird_5fparty_5fperception_2fproto_2fradar_5fobstacle_2eproto(&descriptor_table_modules_2fthird_5fparty_5fperception_2fproto_2fradar_5fobstacle_2eproto);
namespace apollo {
namespace third_party_perception {
...
RadarObstacle::RadarObstacle(const RadarObstacle& from)
  ...
  if (from._internal_has_relative_velocity()) {
    relative_velocity_ = new ::apollo::common::Point3D(*from.relative_velocity_);
  } else {
    relative_velocity_ = nullptr;
  }
  if (from._internal_has_absolute_position()) {
    absolute_position_ = new ::apollo::common::Point3D(*from.absolute_position_);
  } else {
    absolute_position_ = nullptr;
  }
  if (from._internal_has_absolute_velocity()) {
    absolute_velocity_ = new ::apollo::common::Point3D(*from.absolute_velocity_);
  } else {
    absolute_velocity_ = nullptr;
  }
  ::memcpy(&id_, &from.id_,
    static_cast<size_t>(reinterpret_cast<char*>(&moving_frames_count_) -
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&moving_frames_count_) -
...
::PROTOBUF_NAMESPACE_ID::uint8* RadarObstacle::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000020u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(5, this->_internal_movable(), target);
  }
...
void RadarObstacle::InternalSwap(RadarObstacle* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(RadarObstacle, moving_frames_count_)
      + sizeof(RadarObstacle::moving_frames_count_)
...
::PROTOBUF_NAMESPACE_ID::uint8* RadarObstacles::_InternalSerialize(
  ...
  if (!this->_internal_radar_obstacle().empty()) {
    typedef ::PROTOBUF_NAMESPACE_ID::Map< ::PROTOBUF_NAMESPACE_ID::int32, ::apollo::third_party_perception::RadarObstacle >::const_pointer
        ConstPtr;
    ...
    if (stream->IsSerializationDeterministic() &&
      ...
      typedef ::PROTOBUF_NAMESPACE_ID::Map< ::PROTOBUF_NAMESPACE_ID::int32, ::apollo::third_party_perception::RadarObstacle >::size_type size_type;
      size_type n = 0;
      for (::PROTOBUF_NAMESPACE_ID::Map< ::PROTOBUF_NAMESPACE_ID::int32, ::apollo::third_party_perception::RadarObstacle >::const_iterator
...
template<> PROTOBUF_NOINLINE ::apollo::third_party_perception::RadarObstacle* Arena::CreateMaybeMessage< ::apollo::third_party_perception::RadarObstacle >(Arena* arena) {
  return Arena::CreateMessageInternal< ::apollo::third_party_perception::RadarObstacle >(arena);
}
template<> PROTOBUF_NOINLINE ::apollo::third_party_perception::RadarObstacles_RadarObstacleEntry_DoNotUse* Arena::CreateMaybeMessage< ::apollo::third_party_perception::RadarObstacles_RadarObstacleEntry_DoNotUse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::apollo::third_party_perception::RadarObstacles_RadarObstacleEntry_DoNotUse >(arena);
}
template<> PROTOBUF_NOINLINE ::apollo::third_party_perception::RadarObstacles* Arena::CreateMaybeMessage< ::apollo::third_party_perception::RadarObstacles >(Arena* arena) {
