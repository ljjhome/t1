...
class RadarObstacle final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::common::Point3D* release_relative_position();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::common::Point3D* release_relative_velocity();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::common::Point3D* release_absolute_position();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::common::Point3D* release_absolute_velocity();
