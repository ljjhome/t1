...
class Layer final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::Matrix* release_layer_input_weight();
  ...
  PROTOBUF_MUST_USE_RESULT ::Vector* release_layer_bias();
...
class FnnModel final :
 ...
 public:
  ...
  ~FnnModel() override;
  explicit constexpr FnnModel(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT ::Vector* release_samples_mean();
  ...
  PROTOBUF_MUST_USE_RESULT ::Vector* release_samples_std();
...
inline void Layer::set_allocated_layer_input_weight(::Matrix* layer_input_weight) {
  ...
  if (layer_input_weight) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::Matrix>::GetOwningArena(layer_input_weight);
...
inline void Layer::set_allocated_layer_bias(::Vector* layer_bias) {
  ...
  if (layer_bias) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::Vector>::GetOwningArena(layer_bias);
    if (message_arena != submessage_arena) {
...
inline void FnnModel::set_allocated_samples_mean(::Vector* samples_mean) {
  ...
  if (samples_mean) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::Vector>::GetOwningArena(samples_mean);
    if (message_arena != submessage_arena) {
...
inline void FnnModel::set_allocated_samples_std(::Vector* samples_std) {
  ...
  if (samples_std) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::Vector>::GetOwningArena(samples_std);
    if (message_arena != submessage_arena) {
