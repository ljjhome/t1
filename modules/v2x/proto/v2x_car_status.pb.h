...
class CarStatus final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::canbus::ChassisDetail* release_chassis_detail();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::v2x::Junction* release_junction();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::v2x::Id* release_rsu_id();
