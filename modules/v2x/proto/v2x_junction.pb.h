...
class Junction final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::v2x::Id* release_id();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::common::Polygon* release_polygon();
...
inline void Junction::set_allocated_id(::apollo::v2x::Id* id) {
  ...
  if (id) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::apollo::v2x::Id>::GetOwningArena(id);
