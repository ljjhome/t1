...
namespace apollo {
namespace v2x {
constexpr Position2D::Position2D(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : x_(0)
  , y_(0){}
struct Position2DDefaultTypeInternal {
  constexpr Position2DDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT Position2DDefaultTypeInternal _Position2D_default_instance_;
...
constexpr Intersection::Intersection(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : roads_()
  , position_(nullptr)
  , id_(0){}
struct IntersectionDefaultTypeInternal {
  constexpr IntersectionDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT IntersectionDefaultTypeInternal _Intersection_default_instance_;
constexpr Map::Map(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : intersections_()
  , time_stamp_(0)
...
struct PhaseDefaultTypeInternal {
  constexpr PhaseDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PhaseDefaultTypeInternal _Phase_default_instance_;
constexpr IntersectionState::IntersectionState(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : phases_()
  , intersection_id_(0)
  , moy_(0)
...
struct IntersectionStateDefaultTypeInternal {
  constexpr IntersectionStateDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT IntersectionStateDefaultTypeInternal _IntersectionState_default_instance_;
constexpr Spat::Spat(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : intersections_()
  , time_stamp_(0)
...
struct SpatDefaultTypeInternal {
  constexpr SpatDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT SpatDefaultTypeInternal _Spat_default_instance_;
constexpr PolicyData::PolicyData(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : map_(nullptr)
  , spat_(nullptr){}
struct PolicyDataDefaultTypeInternal {
  constexpr PolicyDataDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PolicyDataDefaultTypeInternal _PolicyData_default_instance_;
}  // namespace v2x
}  // namespace apollo
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fv2x_2fproto_2fv2x_5ftraffic_5flight_5fpolicy_2eproto = {
  false, false, 1142, descriptor_table_protodef_modules_2fv2x_2fproto_2fv2x_5ftraffic_5flight_5fpolicy_2eproto, "modules/v2x/proto/v2x_traffic_light_policy.proto", 
  ...
  file_level_metadata_modules_2fv2x_2fproto_2fv2x_5ftraffic_5flight_5fpolicy_2eproto, file_level_enum_descriptors_modules_2fv2x_2fproto_2fv2x_5ftraffic_5flight_5fpolicy_2eproto, file_level_service_descriptors_modules_2fv2x_2fproto_2fv2x_5ftraffic_5flight_5fpolicy_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_modules_2fv2x_2fproto_2fv2x_5ftraffic_5flight_5fpolicy_2eproto_getter() {
  return &descriptor_table_modules_2fv2x_2fproto_2fv2x_5ftraffic_5flight_5fpolicy_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_modules_2fv2x_2fproto_2fv2x_5ftraffic_5flight_5fpolicy_2eproto(&descriptor_table_modules_2fv2x_2fproto_2fv2x_5ftraffic_5flight_5fpolicy_2eproto);
namespace apollo {
namespace v2x {
...
// @@protoc_insertion_point(message_byte_size_start:apollo.v2x.Connection)
  ...
  if (cached_has_bits & 0x00000003u) {
    ...
    // optional int32 phase_id = 2;
    if (cached_has_bits & 0x00000002u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_phase_id());
    }
...
// @@protoc_insertion_point(message_byte_size_start:apollo.v2x.Lane)
  ...
  cached_has_bits = _has_bits_[0];
  if (cached_has_bits & 0x00000001u) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_lane_id());
  }
...
// @@protoc_insertion_point(message_byte_size_start:apollo.v2x.Road)
  ...
  if (cached_has_bits & 0x00000003u) {
    ...
    // optional int32 upstream_node_id = 1;
    if (cached_has_bits & 0x00000002u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_upstream_node_id());
    }
...
// @@protoc_insertion_point(message_byte_size_start:apollo.v2x.IntersectionState)
  ...
  if (cached_has_bits & 0x00000007u) {
    ...
    // optional int32 moy = 3;
    if (cached_has_bits & 0x00000002u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_moy());
    }

    // optional int32 time_stamp_dsecond = 4;
    if (cached_has_bits & 0x00000004u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_time_stamp_dsecond());
    }
