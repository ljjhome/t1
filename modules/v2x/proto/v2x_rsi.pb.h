...
class RsiPoint final :
 ...
 public:
  ...
  ~RsiPoint() override;
  explicit constexpr RsiPoint(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class RsiMsg final :
 ...
 public:
  ...
  ~RsiMsg() override;
  explicit constexpr RsiMsg(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
