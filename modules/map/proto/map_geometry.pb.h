...
class CurveSegment final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::common::PointENU* release_start_position();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::hdmap::LineSegment* release_line_segment();
...
inline ::apollo::hdmap::LineSegment* CurveSegment::_internal_mutable_line_segment() {
  if (!_internal_has_line_segment()) {
    clear_curve_type();
    set_has_line_segment();
    curve_type_.line_segment_ = CreateMaybeMessage< ::apollo::hdmap::LineSegment >(GetArenaForAllocation());
  }
