...
namespace apollo {
namespace hdmap {
constexpr YieldSign::YieldSign(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : stop_line_()
  , overlap_id_()
  , id_(nullptr){}
struct YieldSignDefaultTypeInternal {
  constexpr YieldSignDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT YieldSignDefaultTypeInternal _YieldSign_default_instance_;
}  // namespace hdmap
}  // namespace apollo
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fmap_2fproto_2fmap_5fyield_5fsign_2eproto = {
  false, false, 245, descriptor_table_protodef_modules_2fmap_2fproto_2fmap_5fyield_5fsign_2eproto, "modules/map/proto/map_yield_sign.proto", 
  ...
  file_level_metadata_modules_2fmap_2fproto_2fmap_5fyield_5fsign_2eproto, file_level_enum_descriptors_modules_2fmap_2fproto_2fmap_5fyield_5fsign_2eproto, file_level_service_descriptors_modules_2fmap_2fproto_2fmap_5fyield_5fsign_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_modules_2fmap_2fproto_2fmap_5fyield_5fsign_2eproto_getter() {
  return &descriptor_table_modules_2fmap_2fproto_2fmap_5fyield_5fsign_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_modules_2fmap_2fproto_2fmap_5fyield_5fsign_2eproto(&descriptor_table_modules_2fmap_2fproto_2fmap_5fyield_5fsign_2eproto);
namespace apollo {
namespace hdmap {
