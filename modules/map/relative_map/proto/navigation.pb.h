...
class NavigationPath final :
 ...
 public:
  ...
  explicit constexpr NavigationPath(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::common::Path* release_path();
...
public:
  ...
  explicit constexpr MapMsg_NavigationPathEntry_DoNotUse(
...
class MapMsg final :
 ...
 public:
  ...
  ~MapMsg() override;
  explicit constexpr MapMsg(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::hdmap::Map* release_hdmap();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::localization::LocalizationEstimate* release_localization();
