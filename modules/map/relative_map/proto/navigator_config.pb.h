...
class SampleParam final :
 ...
 public:
  ...
  explicit constexpr SampleParam(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class NavigatorConfig final :
 ...
 public:
  ...
  explicit constexpr NavigatorConfig(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::relative_map::SampleParam* release_sample_param();
...
inline void NavigatorConfig::set_allocated_sample_param(::apollo::relative_map::SampleParam* sample_param) {
  ...
  if (sample_param) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::apollo::relative_map::SampleParam>::GetOwningArena(sample_param);
