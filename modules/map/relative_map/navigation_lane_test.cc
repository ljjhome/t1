...
class NavigationLaneTest : public testing::Test {
 public:
  virtual void SetUp() {
    ...
    EXPECT_TRUE(cyber::common::GetProtoFromFile(
        "/home/ljj/apollo/artest/src/apollo/modules/map/relative_map/conf/relative_map_config.pb.txt", &config));
    ...
    data_file_dir_ = "/home/ljj/apollo/artest/src/apollo/modules/map/relative_map/testdata/multi_lane_map/";
