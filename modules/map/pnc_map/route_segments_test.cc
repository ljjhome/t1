...
DEFINE_string(test_map_file,
              "/home/ljj/apollo/artest/src/apollo/modules/map/data/sunnyvale_loop/base_map_test.bin",
              "The test map file");
DEFINE_string(
    test_routing_file,
    "/home/ljj/apollo/artest/src/apollo/modules/map/pnc_map/testdata/sample_sunnyvale_loop_routing.pb.txt",
    "The test map file");
