...
namespace apollo {
namespace data {
constexpr SmartRecorderStatus::SmartRecorderStatus(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : state_message_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , header_(nullptr)
  , recording_state_(0)
{}
struct SmartRecorderStatusDefaultTypeInternal {
  constexpr SmartRecorderStatusDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT SmartRecorderStatusDefaultTypeInternal _SmartRecorderStatus_default_instance_;
}  // namespace data
}  // namespace apollo
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fdata_2ftools_2fsmart_5frecorder_2fproto_2fsmart_5frecorder_5fstatus_2eproto = {
  false, false, 320, descriptor_table_protodef_modules_2fdata_2ftools_2fsmart_5frecorder_2fproto_2fsmart_5frecorder_5fstatus_2eproto, "modules/data/tools/smart_recorder/proto/smart_recorder_status.proto", 
  ...
  file_level_metadata_modules_2fdata_2ftools_2fsmart_5frecorder_2fproto_2fsmart_5frecorder_5fstatus_2eproto, file_level_enum_descriptors_modules_2fdata_2ftools_2fsmart_5frecorder_2fproto_2fsmart_5frecorder_5fstatus_2eproto, file_level_service_descriptors_modules_2fdata_2ftools_2fsmart_5frecorder_2fproto_2fsmart_5frecorder_5fstatus_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_modules_2fdata_2ftools_2fsmart_5frecorder_2fproto_2fsmart_5frecorder_5fstatus_2eproto_getter() {
  return &descriptor_table_modules_2fdata_2ftools_2fsmart_5frecorder_2fproto_2fsmart_5frecorder_5fstatus_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_modules_2fdata_2ftools_2fsmart_5frecorder_2fproto_2fsmart_5frecorder_5fstatus_2eproto(&descriptor_table_modules_2fdata_2ftools_2fsmart_5frecorder_2fproto_2fsmart_5frecorder_5fstatus_2eproto);
namespace apollo {
namespace data {
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&recording_state_) -
...
void SmartRecorderStatus::ArenaDtor(void* object) {
  SmartRecorderStatus* _this = reinterpret_cast< SmartRecorderStatus* >(object);
  (void)_this;
}
void SmartRecorderStatus::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
void SmartRecorderStatus::InternalSwap(SmartRecorderStatus* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      ...
      &state_message_, lhs_arena,
      &other->state_message_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(SmartRecorderStatus, recording_state_)
      + sizeof(SmartRecorderStatus::recording_state_)
      - PROTOBUF_FIELD_OFFSET(SmartRecorderStatus, header_)>(
