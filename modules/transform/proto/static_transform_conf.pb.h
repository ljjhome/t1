...
class ExtrinsicFile final :
 ...
 public:
  ...
  explicit constexpr ExtrinsicFile(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class Conf final :
 ...
 public:
  ...
  ~Conf() override;
  explicit constexpr Conf(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
