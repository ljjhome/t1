...
class TransformStamped final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::transform::Transform* release_transform();
...
inline void TransformStamped::set_allocated_transform(::apollo::transform::Transform* transform) {
  ...
  if (transform) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::apollo::transform::Transform>::GetOwningArena(transform);
    if (message_arena != submessage_arena) {
