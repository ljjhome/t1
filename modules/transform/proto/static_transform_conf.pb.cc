...
constexpr ExtrinsicFile::ExtrinsicFile(
...
struct ExtrinsicFileDefaultTypeInternal {
  constexpr ExtrinsicFileDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT ExtrinsicFileDefaultTypeInternal _ExtrinsicFile_default_instance_;
constexpr Conf::Conf(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : extrinsic_file_(){}
struct ConfDefaultTypeInternal {
  constexpr ConfDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT ConfDefaultTypeInternal _Conf_default_instance_;
}  // namespace static_transform
}  // namespace apollo
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2ftransform_2fproto_2fstatic_5ftransform_5fconf_2eproto = {
  false, false, 244, descriptor_table_protodef_modules_2ftransform_2fproto_2fstatic_5ftransform_5fconf_2eproto, "modules/transform/proto/static_transform_conf.proto", 
  ...
  file_level_metadata_modules_2ftransform_2fproto_2fstatic_5ftransform_5fconf_2eproto, file_level_enum_descriptors_modules_2ftransform_2fproto_2fstatic_5ftransform_5fconf_2eproto, file_level_service_descriptors_modules_2ftransform_2fproto_2fstatic_5ftransform_5fconf_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_modules_2ftransform_2fproto_2fstatic_5ftransform_5fconf_2eproto_getter() {
  return &descriptor_table_modules_2ftransform_2fproto_2fstatic_5ftransform_5fconf_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_modules_2ftransform_2fproto_2fstatic_5ftransform_5fconf_2eproto(&descriptor_table_modules_2ftransform_2fproto_2fstatic_5ftransform_5fconf_2eproto);
namespace apollo {
namespace static_transform {
