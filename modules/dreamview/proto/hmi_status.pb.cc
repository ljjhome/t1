...
namespace apollo {
namespace dreamview {
constexpr HMIStatus_ModulesEntry_DoNotUse::HMIStatus_ModulesEntry_DoNotUse(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized){}
struct HMIStatus_ModulesEntry_DoNotUseDefaultTypeInternal {
  constexpr HMIStatus_ModulesEntry_DoNotUseDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT HMIStatus_ModulesEntry_DoNotUseDefaultTypeInternal _HMIStatus_ModulesEntry_DoNotUse_default_instance_;
constexpr HMIStatus_MonitoredComponentsEntry_DoNotUse::HMIStatus_MonitoredComponentsEntry_DoNotUse(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized){}
struct HMIStatus_MonitoredComponentsEntry_DoNotUseDefaultTypeInternal {
  constexpr HMIStatus_MonitoredComponentsEntry_DoNotUseDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT HMIStatus_MonitoredComponentsEntry_DoNotUseDefaultTypeInternal _HMIStatus_MonitoredComponentsEntry_DoNotUse_default_instance_;
constexpr HMIStatus_OtherComponentsEntry_DoNotUse::HMIStatus_OtherComponentsEntry_DoNotUse(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized){}
struct HMIStatus_OtherComponentsEntry_DoNotUseDefaultTypeInternal {
  constexpr HMIStatus_OtherComponentsEntry_DoNotUseDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT HMIStatus_OtherComponentsEntry_DoNotUseDefaultTypeInternal _HMIStatus_OtherComponentsEntry_DoNotUse_default_instance_;
constexpr HMIStatus::HMIStatus(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : modes_()
  , maps_()
  , vehicles_()
  ...
  , current_mode_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , current_map_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , current_vehicle_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , docker_image_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , passenger_msg_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , header_(nullptr)
  , utm_zone_id_(0){}
struct HMIStatusDefaultTypeInternal {
  constexpr HMIStatusDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT HMIStatusDefaultTypeInternal _HMIStatus_default_instance_;
}  // namespace dreamview
}  // namespace apollo
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fdreamview_2fproto_2fhmi_5fstatus_2eproto = {
  false, false, 821, descriptor_table_protodef_modules_2fdreamview_2fproto_2fhmi_5fstatus_2eproto, "modules/dreamview/proto/hmi_status.proto", 
  ...
  file_level_metadata_modules_2fdreamview_2fproto_2fhmi_5fstatus_2eproto, file_level_enum_descriptors_modules_2fdreamview_2fproto_2fhmi_5fstatus_2eproto, file_level_service_descriptors_modules_2fdreamview_2fproto_2fhmi_5fstatus_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_modules_2fdreamview_2fproto_2fhmi_5fstatus_2eproto_getter() {
  return &descriptor_table_modules_2fdreamview_2fproto_2fhmi_5fstatus_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_modules_2fdreamview_2fproto_2fhmi_5fstatus_2eproto(&descriptor_table_modules_2fdreamview_2fproto_2fhmi_5fstatus_2eproto);
namespace apollo {
namespace dreamview {
...
inline void HMIStatus::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena) {
  if (arena != nullptr) {
...
// @@protoc_insertion_point(message_byte_size_start:apollo.dreamview.HMIStatus)
  ...
  if (cached_has_bits & 0x0000007fu) {
    ...
    // optional int32 utm_zone_id = 11;
    if (cached_has_bits & 0x00000040u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_utm_zone_id());
    }
...
void HMIStatus::InternalSwap(HMIStatus* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      ...
      &current_mode_, lhs_arena,
      &other->current_mode_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &current_map_, lhs_arena,
      &other->current_map_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &current_vehicle_, lhs_arena,
      &other->current_vehicle_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &passenger_msg_, lhs_arena,
      &other->passenger_msg_, rhs_arena
  );
