...
class CameraUpdate final :
 ...
 public:
  ...
  explicit constexpr CameraUpdate(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline std::string* CameraUpdate::release_image() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return image_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
