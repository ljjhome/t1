...
class Criterion final :
 ...
 public:
  ...
  ~Criterion() override;
  explicit constexpr Criterion(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_vehicle_config();
...
public:
  ...
  explicit constexpr DataCollectionTable_ScenarioEntry_DoNotUse(
...
class DataCollectionTable final :
 ...
 public:
  ...
  explicit constexpr DataCollectionTable(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline DataCollectionTable* New() const final {
    return new DataCollectionTable();
  }
...
void Criterion::set_vehicle_config(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 vehicle_config_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Criterion::_internal_set_vehicle_config(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  vehicle_config_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* Criterion::_internal_mutable_vehicle_config() {
  _has_bits_[0] |= 0x00000002u;
  return vehicle_config_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* Criterion::release_vehicle_config() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  return vehicle_config_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
