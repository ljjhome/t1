...
class DaemonCmd final :
 ...
 public:
  ...
  ~DaemonCmd() override;
  explicit constexpr DaemonCmd(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
void DaemonCmd::set_cmd(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 cmd_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void DaemonCmd::_internal_set_cmd(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  cmd_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* DaemonCmd::_internal_mutable_cmd() {
  _has_bits_[0] |= 0x00000002u;
  return cmd_.Mutable(::modules::teleop::daemon::DaemonCmd::_i_give_permission_to_break_this_code_default_cmd_, GetArenaForAllocation());
}
inline std::string* DaemonCmd::release_cmd() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  return cmd_.ReleaseNonDefault(nullptr, GetArenaForAllocation());
}
