...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fplanning_2fproto_2freference_5fline_5fsmoother_5fconfig_2eproto = {
  false, false, 1633, descriptor_table_protodef_modules_2fplanning_2fproto_2freference_5fline_5fsmoother_5fconfig_2eproto, "modules/planning/proto/reference_line_smoother_config.proto", 
  ...
  file_level_metadata_modules_2fplanning_2fproto_2freference_5fline_5fsmoother_5fconfig_2eproto, file_level_enum_descriptors_modules_2fplanning_2fproto_2freference_5fline_5fsmoother_5fconfig_2eproto, file_level_service_descriptors_modules_2fplanning_2fproto_2freference_5fline_5fsmoother_5fconfig_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_modules_2fplanning_2fproto_2freference_5fline_5fsmoother_5fconfig_2eproto_getter() {
  return &descriptor_table_modules_2fplanning_2fproto_2freference_5fline_5fsmoother_5fconfig_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_modules_2fplanning_2fproto_2freference_5fline_5fsmoother_5fconfig_2eproto(&descriptor_table_modules_2fplanning_2fproto_2freference_5fline_5fsmoother_5fconfig_2eproto);
namespace apollo {
namespace planning {
...
void ReferenceLineSmootherConfig::set_allocated_qp_spline(::apollo::planning::QpSplineSmootherConfig* qp_spline) {
  ...
  if (qp_spline) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::apollo::planning::QpSplineSmootherConfig>::GetOwningArena(qp_spline);
    if (message_arena != submessage_arena) {
...
void ReferenceLineSmootherConfig::set_allocated_spiral(::apollo::planning::SpiralSmootherConfig* spiral) {
  ...
  if (spiral) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::apollo::planning::SpiralSmootherConfig>::GetOwningArena(spiral);
    if (message_arena != submessage_arena) {
...
void ReferenceLineSmootherConfig::set_allocated_discrete_points(::apollo::planning::DiscretePointsSmootherConfig* discrete_points) {
  ...
  if (discrete_points) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::apollo::planning::DiscretePointsSmootherConfig>::GetOwningArena(discrete_points);
    if (message_arena != submessage_arena) {
