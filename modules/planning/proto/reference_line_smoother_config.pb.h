...
class QpSplineSmootherConfig final :
 ...
 public:
  ...
  inline QpSplineSmootherConfig* New() const final {
    return new QpSplineSmootherConfig();
  }
...
class SpiralSmootherConfig final :
 ...
 public:
  ...
  inline SpiralSmootherConfig* New() const final {
    return new SpiralSmootherConfig();
  }
...
class DiscretePointsSmootherConfig final :
 ...
 public:
  ...
  inline DiscretePointsSmootherConfig* New() const final {
    return new DiscretePointsSmootherConfig();
  }
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::planning::CosThetaSmootherConfig* release_cos_theta_smoothing();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::planning::FemPosDeviationSmootherConfig* release_fem_pos_deviation_smoothing();
...
class ReferenceLineSmootherConfig final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::planning::QpSplineSmootherConfig* release_qp_spline();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::planning::SpiralSmootherConfig* release_spiral();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::planning::DiscretePointsSmootherConfig* release_discrete_points();
...
inline ::apollo::planning::CosThetaSmootherConfig* DiscretePointsSmootherConfig::_internal_mutable_cos_theta_smoothing() {
  if (!_internal_has_cos_theta_smoothing()) {
    clear_SmootherConfig();
    set_has_cos_theta_smoothing();
    SmootherConfig_.cos_theta_smoothing_ = CreateMaybeMessage< ::apollo::planning::CosThetaSmootherConfig >(GetArenaForAllocation());
  }
...
inline ::apollo::planning::FemPosDeviationSmootherConfig* DiscretePointsSmootherConfig::_internal_mutable_fem_pos_deviation_smoothing() {
  if (!_internal_has_fem_pos_deviation_smoothing()) {
    clear_SmootherConfig();
    set_has_fem_pos_deviation_smoothing();
    SmootherConfig_.fem_pos_deviation_smoothing_ = CreateMaybeMessage< ::apollo::planning::FemPosDeviationSmootherConfig >(GetArenaForAllocation());
  }
...
inline ::apollo::planning::QpSplineSmootherConfig* ReferenceLineSmootherConfig::_internal_mutable_qp_spline() {
  if (!_internal_has_qp_spline()) {
    clear_SmootherConfig();
    set_has_qp_spline();
    SmootherConfig_.qp_spline_ = CreateMaybeMessage< ::apollo::planning::QpSplineSmootherConfig >(GetArenaForAllocation());
  }
...
inline ::apollo::planning::SpiralSmootherConfig* ReferenceLineSmootherConfig::_internal_mutable_spiral() {
  if (!_internal_has_spiral()) {
    clear_SmootherConfig();
    set_has_spiral();
    SmootherConfig_.spiral_ = CreateMaybeMessage< ::apollo::planning::SpiralSmootherConfig >(GetArenaForAllocation());
  }
...
inline ::apollo::planning::DiscretePointsSmootherConfig* ReferenceLineSmootherConfig::_internal_mutable_discrete_points() {
  if (!_internal_has_discrete_points()) {
    clear_SmootherConfig();
    set_has_discrete_points();
    SmootherConfig_.discrete_points_ = CreateMaybeMessage< ::apollo::planning::DiscretePointsSmootherConfig >(GetArenaForAllocation());
  }
