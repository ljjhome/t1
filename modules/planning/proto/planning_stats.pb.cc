...
namespace apollo {
namespace planning {
constexpr StatsGroup::StatsGroup(
...
struct StatsGroupDefaultTypeInternal {
  constexpr StatsGroupDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT StatsGroupDefaultTypeInternal _StatsGroup_default_instance_;
constexpr PlanningStats::PlanningStats(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
...
struct PlanningStatsDefaultTypeInternal {
  constexpr PlanningStatsDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PlanningStatsDefaultTypeInternal _PlanningStats_default_instance_;
}  // namespace planning
}  // namespace apollo
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fplanning_2fproto_2fplanning_5fstats_2eproto = {
  false, false, 451, descriptor_table_protodef_modules_2fplanning_2fproto_2fplanning_5fstats_2eproto, "modules/planning/proto/planning_stats.proto", 
  ...
  file_level_metadata_modules_2fplanning_2fproto_2fplanning_5fstats_2eproto, file_level_enum_descriptors_modules_2fplanning_2fproto_2fplanning_5fstats_2eproto, file_level_service_descriptors_modules_2fplanning_2fproto_2fplanning_5fstats_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_modules_2fplanning_2fproto_2fplanning_5fstats_2eproto_getter() {
  return &descriptor_table_modules_2fplanning_2fproto_2fplanning_5fstats_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_modules_2fplanning_2fproto_2fplanning_5fstats_2eproto(&descriptor_table_modules_2fplanning_2fproto_2fplanning_5fstats_2eproto);
namespace apollo {
namespace planning {
