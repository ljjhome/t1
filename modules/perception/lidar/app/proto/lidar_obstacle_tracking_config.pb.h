...
class LidarObstacleTrackingConfig final :
 ...
 public:
  ...
  explicit constexpr LidarObstacleTrackingConfig(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline LidarObstacleTrackingConfig* New() const final {
    return new LidarObstacleTrackingConfig();
  }
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_multi_target_tracker();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_frame_classifier();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_fusion_classifier();
...
inline const std::string& LidarObstacleTrackingConfig::multi_target_tracker() const {
  ...
  if (multi_target_tracker_.IsDefault(nullptr)) return _i_give_permission_to_break_this_code_default_multi_target_tracker_.get();
...
void LidarObstacleTrackingConfig::set_multi_target_tracker(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 multi_target_tracker_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& LidarObstacleTrackingConfig::_internal_multi_target_tracker() const {
  return multi_target_tracker_.Get();
}
inline void LidarObstacleTrackingConfig::_internal_set_multi_target_tracker(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  multi_target_tracker_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* LidarObstacleTrackingConfig::_internal_mutable_multi_target_tracker() {
  _has_bits_[0] |= 0x00000001u;
  return multi_target_tracker_.Mutable(::apollo::perception::lidar::LidarObstacleTrackingConfig::_i_give_permission_to_break_this_code_default_multi_target_tracker_, GetArenaForAllocation());
}
inline std::string* LidarObstacleTrackingConfig::release_multi_target_tracker() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return multi_target_tracker_.ReleaseNonDefault(nullptr, GetArenaForAllocation());
}
inline void LidarObstacleTrackingConfig::set_allocated_multi_target_tracker(std::string* multi_target_tracker) {
  ...
  multi_target_tracker_.SetAllocated(nullptr, multi_target_tracker,
...
inline const std::string& LidarObstacleTrackingConfig::frame_classifier() const {
  ...
  if (frame_classifier_.IsDefault(nullptr)) return _i_give_permission_to_break_this_code_default_frame_classifier_.get();
...
void LidarObstacleTrackingConfig::set_frame_classifier(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 frame_classifier_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& LidarObstacleTrackingConfig::_internal_frame_classifier() const {
  return frame_classifier_.Get();
}
inline void LidarObstacleTrackingConfig::_internal_set_frame_classifier(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  frame_classifier_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* LidarObstacleTrackingConfig::_internal_mutable_frame_classifier() {
  _has_bits_[0] |= 0x00000002u;
  return frame_classifier_.Mutable(::apollo::perception::lidar::LidarObstacleTrackingConfig::_i_give_permission_to_break_this_code_default_frame_classifier_, GetArenaForAllocation());
}
inline std::string* LidarObstacleTrackingConfig::release_frame_classifier() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  return frame_classifier_.ReleaseNonDefault(nullptr, GetArenaForAllocation());
}
inline void LidarObstacleTrackingConfig::set_allocated_frame_classifier(std::string* frame_classifier) {
  ...
  frame_classifier_.SetAllocated(nullptr, frame_classifier,
      GetArenaForAllocation());
...
inline const std::string& LidarObstacleTrackingConfig::fusion_classifier() const {
  ...
  if (fusion_classifier_.IsDefault(nullptr)) return _i_give_permission_to_break_this_code_default_fusion_classifier_.get();
...
void LidarObstacleTrackingConfig::set_fusion_classifier(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000004u;
 fusion_classifier_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& LidarObstacleTrackingConfig::_internal_fusion_classifier() const {
  return fusion_classifier_.Get();
}
inline void LidarObstacleTrackingConfig::_internal_set_fusion_classifier(const std::string& value) {
  _has_bits_[0] |= 0x00000004u;
  fusion_classifier_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* LidarObstacleTrackingConfig::_internal_mutable_fusion_classifier() {
  _has_bits_[0] |= 0x00000004u;
  return fusion_classifier_.Mutable(::apollo::perception::lidar::LidarObstacleTrackingConfig::_i_give_permission_to_break_this_code_default_fusion_classifier_, GetArenaForAllocation());
}
inline std::string* LidarObstacleTrackingConfig::release_fusion_classifier() {
  ...
  _has_bits_[0] &= ~0x00000004u;
  return fusion_classifier_.ReleaseNonDefault(nullptr, GetArenaForAllocation());
}
inline void LidarObstacleTrackingConfig::set_allocated_fusion_classifier(std::string* fusion_classifier) {
  ...
  fusion_classifier_.SetAllocated(nullptr, fusion_classifier,
      GetArenaForAllocation());
