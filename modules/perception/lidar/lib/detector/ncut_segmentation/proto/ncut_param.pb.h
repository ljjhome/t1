...
class NCutSegmentationParam final :
 ...
 public:
  ...
  explicit constexpr NCutSegmentationParam(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline NCutSegmentationParam* New() const final {
    return new NCutSegmentationParam();
  }
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::perception::lidar::NCutParam* release_ncut_param();
...
class NCutParam final :
 ...
 public:
  ...
  ~NCutParam() override;
  explicit constexpr NCutParam(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline std::string* NCutSegmentationParam::_internal_mutable_ground_detector() {
  _has_bits_[0] |= 0x00000001u;
  return ground_detector_.Mutable(::apollo::perception::lidar::NCutSegmentationParam::_i_give_permission_to_break_this_code_default_ground_detector_, GetArenaForAllocation());
}
...
inline std::string* NCutSegmentationParam::_internal_mutable_roi_filter() {
  _has_bits_[0] |= 0x00000002u;
  return roi_filter_.Mutable(::apollo::perception::lidar::NCutSegmentationParam::_i_give_permission_to_break_this_code_default_roi_filter_, GetArenaForAllocation());
}
...
inline bool NCutSegmentationParam::_internal_has_ncut_param() const {
  ...
  PROTOBUF_ASSUME(!value || ncut_param_ != nullptr);
  return value;
}
...
inline void NCutSegmentationParam::unsafe_arena_set_allocated_ncut_param(
  ...
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(ncut_param_);
  }
  ncut_param_ = ncut_param;
  if (ncut_param) {
    _has_bits_[0] |= 0x00000004u;
  } else {
    _has_bits_[0] &= ~0x00000004u;
...
inline ::apollo::perception::lidar::NCutParam* NCutSegmentationParam::release_ncut_param() {
  _has_bits_[0] &= ~0x00000004u;
  ::apollo::perception::lidar::NCutParam* temp = ncut_param_;
  ncut_param_ = nullptr;
...
inline void NCutSegmentationParam::set_allocated_ncut_param(::apollo::perception::lidar::NCutParam* ncut_param) {
  ...
  if (ncut_param) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::apollo::perception::lidar::NCutParam>::GetOwningArena(ncut_param);
