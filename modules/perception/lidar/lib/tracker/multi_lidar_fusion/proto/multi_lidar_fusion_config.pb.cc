...
namespace lidar {
constexpr MlfDistanceWeight::MlfDistanceWeight(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : sensor_name_pair_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  ...
  , semantic_map_dist_weight_(0){}
struct MlfDistanceWeightDefaultTypeInternal {
  constexpr MlfDistanceWeightDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT MlfDistanceWeightDefaultTypeInternal _MlfDistanceWeight_default_instance_;
constexpr MlfDistanceConfig::MlfDistanceConfig(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : foreground_weights_()
  , background_weights_(){}
struct MlfDistanceConfigDefaultTypeInternal {
  constexpr MlfDistanceConfigDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT MlfDistanceConfigDefaultTypeInternal _MlfDistanceConfig_default_instance_;
constexpr MlfTrackObjectMatcherConfig::MlfTrackObjectMatcherConfig(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : foreground_mathcer_method_(nullptr)
  , background_matcher_method_(nullptr)
  , bound_value_(100)
  , max_match_distance_(4){}
struct MlfTrackObjectMatcherConfigDefaultTypeInternal {
  constexpr MlfTrackObjectMatcherConfigDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT MlfTrackObjectMatcherConfigDefaultTypeInternal _MlfTrackObjectMatcherConfig_default_instance_;
constexpr MlfTrackerConfig::MlfTrackerConfig(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : filter_name_(){}
struct MlfTrackerConfigDefaultTypeInternal {
  constexpr MlfTrackerConfigDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT MlfTrackerConfigDefaultTypeInternal _MlfTrackerConfig_default_instance_;
constexpr MlfMotionFilterConfig::MlfMotionFilterConfig(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
...
struct MlfMotionFilterConfigDefaultTypeInternal {
  constexpr MlfMotionFilterConfigDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT MlfMotionFilterConfigDefaultTypeInternal _MlfMotionFilterConfig_default_instance_;
constexpr MlfMotionRefinerConfig::MlfMotionRefinerConfig(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : claping_acceleration_threshold_(10)
  , claping_speed_threshold_(1){}
struct MlfMotionRefinerConfigDefaultTypeInternal {
  constexpr MlfMotionRefinerConfigDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT MlfMotionRefinerConfigDefaultTypeInternal _MlfMotionRefinerConfig_default_instance_;
constexpr MlfShapeFilterConfig::MlfShapeFilterConfig(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : bottom_points_ignore_threshold_(0.1)
  , top_points_ignore_threshold_(1.6){}
struct MlfShapeFilterConfigDefaultTypeInternal {
  constexpr MlfShapeFilterConfigDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT MlfShapeFilterConfigDefaultTypeInternal _MlfShapeFilterConfig_default_instance_;
constexpr MlfEngineConfig::MlfEngineConfig(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : main_sensor_()
...
struct MlfEngineConfigDefaultTypeInternal {
  constexpr MlfEngineConfigDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT MlfEngineConfigDefaultTypeInternal _MlfEngineConfig_default_instance_;
}  // namespace lidar
}  // namespace perception
}  // namespace apollo
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_modules_2fperception_2flidar_2flib_2ftracker_2fmulti_5flidar_5ffusion_2fproto_2fmulti_5flidar_5ffusion_5fconfig_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::apollo::perception::lidar::MlfDistanceWeight, semantic_map_dist_weight_),
  0,
  1,
  2,
  3,
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fperception_2flidar_2flib_2ftracker_2fmulti_5flidar_5ffusion_2fproto_2fmulti_5flidar_5ffusion_5fconfig_2eproto = {
  false, false, 1781, descriptor_table_protodef_modules_2fperception_2flidar_2flib_2ftracker_2fmulti_5flidar_5ffusion_2fproto_2fmulti_5flidar_5ffusion_5fconfig_2eproto, "modules/perception/lidar/lib/tracker/multi_lidar_fusion/proto/multi_lidar_fusion_config.proto", 
  ...
  file_level_metadata_modules_2fperception_2flidar_2flib_2ftracker_2fmulti_5flidar_5ffusion_2fproto_2fmulti_5flidar_5ffusion_5fconfig_2eproto, file_level_enum_descriptors_modules_2fperception_2flidar_2flib_2ftracker_2fmulti_5flidar_5ffusion_2fproto_2fmulti_5flidar_5ffusion_5fconfig_2eproto, file_level_service_descriptors_modules_2fperception_2flidar_2flib_2ftracker_2fmulti_5flidar_5ffusion_2fproto_2fmulti_5flidar_5ffusion_5fconfig_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_modules_2fperception_2flidar_2flib_2ftracker_2fmulti_5flidar_5ffusion_2fproto_2fmulti_5flidar_5ffusion_5fconfig_2eproto_getter() {
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_modules_2fperception_2flidar_2flib_2ftracker_2fmulti_5flidar_5ffusion_2fproto_2fmulti_5flidar_5ffusion_5fconfig_2eproto(&descriptor_table_modules_2fperception_2flidar_2flib_2ftracker_2fmulti_5flidar_5ffusion_2fproto_2fmulti_5flidar_5ffusion_5fconfig_2eproto);
namespace apollo {
namespace perception {
namespace lidar {
...
MlfDistanceWeight::MlfDistanceWeight(const MlfDistanceWeight& from)
  ...
  if (from._internal_has_sensor_name_pair()) {
    sensor_name_pair_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_sensor_name_pair(), 
      GetArenaForAllocation());
  }
  ::memcpy(&location_dist_weight_, &from.location_dist_weight_,
    static_cast<size_t>(reinterpret_cast<char*>(&semantic_map_dist_weight_) -
    reinterpret_cast<char*>(&location_dist_weight_)) + sizeof(semantic_map_dist_weight_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&location_dist_weight_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&semantic_map_dist_weight_) -
    reinterpret_cast<char*>(&location_dist_weight_)) + sizeof(semantic_map_dist_weight_));
}
...
void MlfDistanceWeight::ArenaDtor(void* object) {
  MlfDistanceWeight* _this = reinterpret_cast< MlfDistanceWeight* >(object);
  (void)_this;
}
void MlfDistanceWeight::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
// @@protoc_insertion_point(message_clear_start:apollo.perception.lidar.MlfDistanceWeight)
  ...
  if (cached_has_bits & 0x00000001u) {
    sensor_name_pair_.ClearNonDefaultToEmpty();
  }
    ...
    switch (tag >> 3) {
      ...
      case 9:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 77)) {
          ...
          semantic_map_dist_weight_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<float>(ptr);
          ptr += sizeof(float);
        } else
          goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* MlfDistanceWeight::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000100u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteFloatToArray(9, this->_internal_semantic_map_dist_weight(), target);
  }
...
void MlfDistanceWeight::InternalSwap(MlfDistanceWeight* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      ...
      &sensor_name_pair_, lhs_arena,
      &other->sensor_name_pair_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(MlfDistanceWeight, semantic_map_dist_weight_)
      + sizeof(MlfDistanceWeight::semantic_map_dist_weight_)
      - PROTOBUF_FIELD_OFFSET(MlfDistanceWeight, location_dist_weight_)>(
          reinterpret_cast<char*>(&location_dist_weight_),
          reinterpret_cast<char*>(&other->location_dist_weight_));
}
...
MlfDistanceConfig::MlfDistanceConfig(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned),
  foreground_weights_(arena),
  background_weights_(arena) {
  SharedCtor();
  if (!is_message_owned) {
    RegisterArenaDtor(arena);
  }
...
void MlfDistanceConfig::ArenaDtor(void* object) {
  MlfDistanceConfig* _this = reinterpret_cast< MlfDistanceConfig* >(object);
  (void)_this;
}
void MlfDistanceConfig::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
const ::PROTOBUF_NAMESPACE_ID::internal::LazyString MlfTrackObjectMatcherConfig::_i_give_permission_to_break_this_code_default_foreground_mathcer_method_{{{"MultiHmBipartiteGraphMatcher", 28}}, {nullptr}};
const ::PROTOBUF_NAMESPACE_ID::internal::LazyString MlfTrackObjectMatcherConfig::_i_give_permission_to_break_this_code_default_background_matcher_method_{{{"GnnBipartiteGraphMatcher", 24}}, {nullptr}};
...
MlfTrackObjectMatcherConfig::MlfTrackObjectMatcherConfig(const MlfTrackObjectMatcherConfig& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      _has_bits_(from._has_bits_) {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  foreground_mathcer_method_.UnsafeSetDefault(nullptr);
  if (from._internal_has_foreground_mathcer_method()) {
    foreground_mathcer_method_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, from._internal_foreground_mathcer_method(), 
      GetArenaForAllocation());
  }
  background_matcher_method_.UnsafeSetDefault(nullptr);
  if (from._internal_has_background_matcher_method()) {
    background_matcher_method_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, from._internal_background_matcher_method(), 
      GetArenaForAllocation());
  }
...
inline void MlfTrackObjectMatcherConfig::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  foreground_mathcer_method_.DestroyNoArena(nullptr);
  background_matcher_method_.DestroyNoArena(nullptr);
}

void MlfTrackObjectMatcherConfig::ArenaDtor(void* object) {
  MlfTrackObjectMatcherConfig* _this = reinterpret_cast< MlfTrackObjectMatcherConfig* >(object);
  (void)_this;
}
void MlfTrackObjectMatcherConfig::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
// @@protoc_insertion_point(message_clear_start:apollo.perception.lidar.MlfTrackObjectMatcherConfig)
  ...
  if (cached_has_bits & 0x0000000fu) {
    if (cached_has_bits & 0x00000001u) {
      foreground_mathcer_method_.ClearToDefault(::apollo::perception::lidar::MlfTrackObjectMatcherConfig::_i_give_permission_to_break_this_code_default_foreground_mathcer_method_, GetArenaForAllocation());
       }
    if (cached_has_bits & 0x00000002u) {
      background_matcher_method_.ClearToDefault(::apollo::perception::lidar::MlfTrackObjectMatcherConfig::_i_give_permission_to_break_this_code_default_background_matcher_method_, GetArenaForAllocation());
       }
    bound_value_ = 100;
    max_match_distance_ = 4;
  }
...
void MlfTrackObjectMatcherConfig::InternalSwap(MlfTrackObjectMatcherConfig* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      nullptr,
      &foreground_mathcer_method_, lhs_arena,
      &other->foreground_mathcer_method_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      nullptr,
      &background_matcher_method_, lhs_arena,
      &other->background_matcher_method_, rhs_arena
  );
...
void MlfTrackerConfig::ArenaDtor(void* object) {
  MlfTrackerConfig* _this = reinterpret_cast< MlfTrackerConfig* >(object);
  (void)_this;
}
void MlfTrackerConfig::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
void MlfMotionFilterConfig::ArenaDtor(void* object) {
  MlfMotionFilterConfig* _this = reinterpret_cast< MlfMotionFilterConfig* >(object);
  (void)_this;
}
void MlfMotionFilterConfig::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          ...
          use_adaptive_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 16)) {
          ...
          use_breakdown_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 24)) {
          ...
          use_convergence_boostup_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 8:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 64)) {
          ...
          boostup_history_size_minimum_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 9:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 72)) {
          ...
          boostup_history_size_maximum_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(message_byte_size_start:apollo.perception.lidar.MlfMotionFilterConfig)
  ...
  if (cached_has_bits & 0x000000ffu) {
    // optional uint32 boostup_history_size_maximum = 9 [default = 6];
    if (cached_has_bits & 0x00000001u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_boostup_history_size_maximum());
    }
    ...
    // optional uint32 boostup_history_size_minimum = 8 [default = 3];
    if (cached_has_bits & 0x00000010u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_boostup_history_size_minimum());
    }
...
void MlfMotionRefinerConfig::ArenaDtor(void* object) {
  MlfMotionRefinerConfig* _this = reinterpret_cast< MlfMotionRefinerConfig* >(object);
  (void)_this;
}
void MlfMotionRefinerConfig::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
void MlfShapeFilterConfig::ArenaDtor(void* object) {
  MlfShapeFilterConfig* _this = reinterpret_cast< MlfShapeFilterConfig* >(object);
  (void)_this;
}
void MlfShapeFilterConfig::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&output_predict_objects_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&use_frame_timestamp_) -
...
void MlfEngineConfig::ArenaDtor(void* object) {
  MlfEngineConfig* _this = reinterpret_cast< MlfEngineConfig* >(object);
  (void)_this;
}
void MlfEngineConfig::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 16)) {
          ...
          use_histogram_for_match_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 24)) {
          ...
          histogram_bin_size_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 32)) {
          ...
          output_predict_objects_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 48)) {
          ...
          use_frame_timestamp_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(message_byte_size_start:apollo.perception.lidar.MlfEngineConfig)
  ...
  if (cached_has_bits & 0x0000001fu) {
    ...
    // optional uint32 histogram_bin_size = 3 [default = 10];
    if (cached_has_bits & 0x00000008u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_histogram_bin_size());
    }
...
void MlfEngineConfig::InternalSwap(MlfEngineConfig* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(MlfEngineConfig, use_frame_timestamp_)
      + sizeof(MlfEngineConfig::use_frame_timestamp_)
      - PROTOBUF_FIELD_OFFSET(MlfEngineConfig, output_predict_objects_)>(
          reinterpret_cast<char*>(&output_predict_objects_),
          reinterpret_cast<char*>(&other->output_predict_objects_));
