...
// @@protoc_insertion_point(message_byte_size_start:apollo.perception.fusion.ProbabilisticFusionConfig)
  ...
  if (cached_has_bits & 0x00000300u) {
    ...
    // optional int64 max_cached_frame_num = 11 [default = 50];
    if (cached_has_bits & 0x00000200u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int64SizePlusOne(this->_internal_max_cached_frame_num());
    }
...
void ProbabilisticFusionConfig::InternalSwap(ProbabilisticFusionConfig* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      nullptr,
      &tracker_method_, lhs_arena,
      &other->tracker_method_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      nullptr,
      &data_association_method_, lhs_arena,
      &other->data_association_method_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      nullptr,
      &gate_keeper_method_, lhs_arena,
      &other->gate_keeper_method_, rhs_arena
  );
