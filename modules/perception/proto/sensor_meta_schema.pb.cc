...
constexpr SensorMeta::SensorMeta(
...
struct SensorMetaDefaultTypeInternal {
  constexpr SensorMetaDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT SensorMetaDefaultTypeInternal _SensorMeta_default_instance_;
constexpr MultiSensorMeta::MultiSensorMeta(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : sensor_meta_(){}
struct MultiSensorMetaDefaultTypeInternal {
  constexpr MultiSensorMetaDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT MultiSensorMetaDefaultTypeInternal _MultiSensorMeta_default_instance_;
}  // namespace perception
}  // namespace apollo
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fperception_2fproto_2fsensor_5fmeta_5fschema_2eproto = {
  false, false, 701, descriptor_table_protodef_modules_2fperception_2fproto_2fsensor_5fmeta_5fschema_2eproto, "modules/perception/proto/sensor_meta_schema.proto", 
  ...
  file_level_metadata_modules_2fperception_2fproto_2fsensor_5fmeta_5fschema_2eproto, file_level_enum_descriptors_modules_2fperception_2fproto_2fsensor_5fmeta_5fschema_2eproto, file_level_service_descriptors_modules_2fperception_2fproto_2fsensor_5fmeta_5fschema_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_modules_2fperception_2fproto_2fsensor_5fmeta_5fschema_2eproto_getter() {
  return &descriptor_table_modules_2fperception_2fproto_2fsensor_5fmeta_5fschema_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_modules_2fperception_2fproto_2fsensor_5fmeta_5fschema_2eproto(&descriptor_table_modules_2fperception_2fproto_2fsensor_5fmeta_5fschema_2eproto);
namespace apollo {
namespace perception {
...
void SensorMeta::ArenaDtor(void* object) {
  SensorMeta* _this = reinterpret_cast< SensorMeta* >(object);
  (void)_this;
}
void SensorMeta::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
void MultiSensorMeta::ArenaDtor(void* object) {
  MultiSensorMeta* _this = reinterpret_cast< MultiSensorMeta* >(object);
  (void)_this;
}
void MultiSensorMeta::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
