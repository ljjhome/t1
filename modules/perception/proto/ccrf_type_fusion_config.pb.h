...
class CcrfTypeFusionConfig final :
 ...
 public:
  ...
  explicit constexpr CcrfTypeFusionConfig(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline CcrfTypeFusionConfig* New() const final {
    return new CcrfTypeFusionConfig();
  }
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_classifiers_property_file_path();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_transition_property_file_path();
...
inline void CcrfTypeFusionConfig::clear_classifiers_property_file_path() {
  classifiers_property_file_path_.ClearToEmpty();
...
void CcrfTypeFusionConfig::set_classifiers_property_file_path(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 classifiers_property_file_path_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& CcrfTypeFusionConfig::_internal_classifiers_property_file_path() const {
  return classifiers_property_file_path_.Get();
}
inline void CcrfTypeFusionConfig::_internal_set_classifiers_property_file_path(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  classifiers_property_file_path_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* CcrfTypeFusionConfig::_internal_mutable_classifiers_property_file_path() {
  _has_bits_[0] |= 0x00000001u;
  return classifiers_property_file_path_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* CcrfTypeFusionConfig::release_classifiers_property_file_path() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return classifiers_property_file_path_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void CcrfTypeFusionConfig::set_allocated_classifiers_property_file_path(std::string* classifiers_property_file_path) {
  ...
  classifiers_property_file_path_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), classifiers_property_file_path,
...
inline void CcrfTypeFusionConfig::clear_transition_property_file_path() {
  transition_property_file_path_.ClearToEmpty();
...
void CcrfTypeFusionConfig::set_transition_property_file_path(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 transition_property_file_path_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& CcrfTypeFusionConfig::_internal_transition_property_file_path() const {
  return transition_property_file_path_.Get();
}
inline void CcrfTypeFusionConfig::_internal_set_transition_property_file_path(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  transition_property_file_path_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* CcrfTypeFusionConfig::_internal_mutable_transition_property_file_path() {
  _has_bits_[0] |= 0x00000002u;
  return transition_property_file_path_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* CcrfTypeFusionConfig::release_transition_property_file_path() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  return transition_property_file_path_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void CcrfTypeFusionConfig::set_allocated_transition_property_file_path(std::string* transition_property_file_path) {
  ...
  transition_property_file_path_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), transition_property_file_path,
      GetArenaForAllocation());
