...
class CameraValidDist final :
 ...
 public:
  ...
  explicit constexpr CameraValidDist(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class DstExistenceFusionConfig final :
 ...
 public:
  ...
  explicit constexpr DstExistenceFusionConfig(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline DstExistenceFusionConfig* New() const final {
    return new DstExistenceFusionConfig();
  }

  DstExistenceFusionConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
