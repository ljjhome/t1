...
namespace fusion {
constexpr PbfTrackerConfig::PbfTrackerConfig(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : type_fusion_method_(nullptr)
  , motion_fusion_method_(nullptr)
  , shape_fusion_method_(nullptr)
  , existence_fusion_method_(nullptr){}
struct PbfTrackerConfigDefaultTypeInternal {
  constexpr PbfTrackerConfigDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PbfTrackerConfigDefaultTypeInternal _PbfTrackerConfig_default_instance_;
}  // namespace fusion
}  // namespace perception
}  // namespace apollo
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_modules_2fperception_2fproto_2fpbf_5ftracker_5fconfig_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::apollo::perception::fusion::PbfTrackerConfig, existence_fusion_method_),
  0,
  1,
  2,
  3,
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fperception_2fproto_2fpbf_5ftracker_5fconfig_2eproto = {
  false, false, 289, descriptor_table_protodef_modules_2fperception_2fproto_2fpbf_5ftracker_5fconfig_2eproto, "modules/perception/proto/pbf_tracker_config.proto", 
  ...
  file_level_metadata_modules_2fperception_2fproto_2fpbf_5ftracker_5fconfig_2eproto, file_level_enum_descriptors_modules_2fperception_2fproto_2fpbf_5ftracker_5fconfig_2eproto, file_level_service_descriptors_modules_2fperception_2fproto_2fpbf_5ftracker_5fconfig_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_modules_2fperception_2fproto_2fpbf_5ftracker_5fconfig_2eproto_getter() {
  return &descriptor_table_modules_2fperception_2fproto_2fpbf_5ftracker_5fconfig_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_modules_2fperception_2fproto_2fpbf_5ftracker_5fconfig_2eproto(&descriptor_table_modules_2fperception_2fproto_2fpbf_5ftracker_5fconfig_2eproto);
namespace apollo {
namespace perception {
namespace fusion {
...
const ::PROTOBUF_NAMESPACE_ID::internal::LazyString PbfTrackerConfig::_i_give_permission_to_break_this_code_default_type_fusion_method_{{{"DstTypeFusion", 13}}, {nullptr}};
const ::PROTOBUF_NAMESPACE_ID::internal::LazyString PbfTrackerConfig::_i_give_permission_to_break_this_code_default_motion_fusion_method_{{{"KalmanMotionFusion", 18}}, {nullptr}};
const ::PROTOBUF_NAMESPACE_ID::internal::LazyString PbfTrackerConfig::_i_give_permission_to_break_this_code_default_shape_fusion_method_{{{"PbfShapeFusion", 14}}, {nullptr}};
const ::PROTOBUF_NAMESPACE_ID::internal::LazyString PbfTrackerConfig::_i_give_permission_to_break_this_code_default_existence_fusion_method_{{{"DstExistenceFusion", 18}}, {nullptr}};
...
PbfTrackerConfig::PbfTrackerConfig(const PbfTrackerConfig& from)
  ...
  type_fusion_method_.UnsafeSetDefault(nullptr);
  if (from._internal_has_type_fusion_method()) {
    type_fusion_method_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, from._internal_type_fusion_method(), 
      GetArenaForAllocation());
  }
  motion_fusion_method_.UnsafeSetDefault(nullptr);
  if (from._internal_has_motion_fusion_method()) {
    motion_fusion_method_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, from._internal_motion_fusion_method(), 
      GetArenaForAllocation());
  }
  shape_fusion_method_.UnsafeSetDefault(nullptr);
  if (from._internal_has_shape_fusion_method()) {
    shape_fusion_method_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, from._internal_shape_fusion_method(), 
      GetArenaForAllocation());
  }
  existence_fusion_method_.UnsafeSetDefault(nullptr);
  if (from._internal_has_existence_fusion_method()) {
    existence_fusion_method_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, from._internal_existence_fusion_method(), 
      GetArenaForAllocation());
  }
...
inline void PbfTrackerConfig::SharedDtor() {
  ...
  type_fusion_method_.DestroyNoArena(nullptr);
  motion_fusion_method_.DestroyNoArena(nullptr);
  shape_fusion_method_.DestroyNoArena(nullptr);
  existence_fusion_method_.DestroyNoArena(nullptr);
}

void PbfTrackerConfig::ArenaDtor(void* object) {
  PbfTrackerConfig* _this = reinterpret_cast< PbfTrackerConfig* >(object);
  (void)_this;
}
void PbfTrackerConfig::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
// @@protoc_insertion_point(message_clear_start:apollo.perception.fusion.PbfTrackerConfig)
  ...
  if (cached_has_bits & 0x0000000fu) {
    if (cached_has_bits & 0x00000001u) {
      type_fusion_method_.ClearToDefault(::apollo::perception::fusion::PbfTrackerConfig::_i_give_permission_to_break_this_code_default_type_fusion_method_, GetArenaForAllocation());
       }
    if (cached_has_bits & 0x00000002u) {
      motion_fusion_method_.ClearToDefault(::apollo::perception::fusion::PbfTrackerConfig::_i_give_permission_to_break_this_code_default_motion_fusion_method_, GetArenaForAllocation());
       }
    if (cached_has_bits & 0x00000004u) {
      shape_fusion_method_.ClearToDefault(::apollo::perception::fusion::PbfTrackerConfig::_i_give_permission_to_break_this_code_default_shape_fusion_method_, GetArenaForAllocation());
       }
    if (cached_has_bits & 0x00000008u) {
      existence_fusion_method_.ClearToDefault(::apollo::perception::fusion::PbfTrackerConfig::_i_give_permission_to_break_this_code_default_existence_fusion_method_, GetArenaForAllocation());
       }
  }
  _has_bits_.Clear();
    ...
    switch (tag >> 3) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 34)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          #ifndef NDEBUG
          ::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "apollo.perception.fusion.PbfTrackerConfig.existence_fusion_method");
          #endif  // !NDEBUG
          CHK_(ptr);
        } else
          goto handle_unusual;
...
void PbfTrackerConfig::InternalSwap(PbfTrackerConfig* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      nullptr,
      &type_fusion_method_, lhs_arena,
      &other->type_fusion_method_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      nullptr,
      &motion_fusion_method_, lhs_arena,
      &other->motion_fusion_method_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      nullptr,
      &shape_fusion_method_, lhs_arena,
      &other->shape_fusion_method_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      nullptr,
      &existence_fusion_method_, lhs_arena,
      &other->existence_fusion_method_, rhs_arena
  );
}
