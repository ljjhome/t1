...
constexpr PerceptionLanes::PerceptionLanes(
...
struct PerceptionLanesDefaultTypeInternal {
  constexpr PerceptionLanesDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PerceptionLanesDefaultTypeInternal _PerceptionLanes_default_instance_;
}  // namespace perception
}  // namespace apollo
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fperception_2fproto_2fperception_5flane_2eproto = {
  false, false, 446, descriptor_table_protodef_modules_2fperception_2fproto_2fperception_5flane_2eproto, "modules/perception/proto/perception_lane.proto", 
  ...
  file_level_metadata_modules_2fperception_2fproto_2fperception_5flane_2eproto, file_level_enum_descriptors_modules_2fperception_2fproto_2fperception_5flane_2eproto, file_level_service_descriptors_modules_2fperception_2fproto_2fperception_5flane_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_modules_2fperception_2fproto_2fperception_5flane_2eproto_getter() {
  return &descriptor_table_modules_2fperception_2fproto_2fperception_5flane_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_modules_2fperception_2fproto_2fperception_5flane_2eproto(&descriptor_table_modules_2fperception_2fproto_2fperception_5flane_2eproto);
namespace apollo {
namespace perception {
...
void PerceptionLanes::InternalSwap(PerceptionLanes* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      ...
      &source_topic_, lhs_arena,
      &other->source_topic_, rhs_arena
  );
