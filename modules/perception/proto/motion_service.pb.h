...
class VehicleStatus final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::perception::MotionType* release_motion();
...
class Motion_Service final :
 ...
 public:
  ...
  explicit constexpr Motion_Service(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline void VehicleStatus::set_allocated_motion(::apollo::perception::MotionType* motion) {
  ...
  if (motion) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::apollo::perception::MotionType>::GetOwningArena(motion);
