...
namespace onboard {
constexpr MotionService::MotionService(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : camera_names_(nullptr)
  , input_camera_channel_names_(nullptr)
  , input_localization_channel_name_(nullptr)
  , output_topic_channel_name_(nullptr){}
struct MotionServiceDefaultTypeInternal {
  constexpr MotionServiceDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT MotionServiceDefaultTypeInternal _MotionService_default_instance_;
}  // namespace onboard
}  // namespace perception
}  // namespace apollo
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fperception_2fonboard_2fproto_2fmotion_5fservice_2eproto = {
  false, false, 346, descriptor_table_protodef_modules_2fperception_2fonboard_2fproto_2fmotion_5fservice_2eproto, "modules/perception/onboard/proto/motion_service.proto", 
  ...
  file_level_metadata_modules_2fperception_2fonboard_2fproto_2fmotion_5fservice_2eproto, file_level_enum_descriptors_modules_2fperception_2fonboard_2fproto_2fmotion_5fservice_2eproto, file_level_service_descriptors_modules_2fperception_2fonboard_2fproto_2fmotion_5fservice_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_modules_2fperception_2fonboard_2fproto_2fmotion_5fservice_2eproto_getter() {
  return &descriptor_table_modules_2fperception_2fonboard_2fproto_2fmotion_5fservice_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_modules_2fperception_2fonboard_2fproto_2fmotion_5fservice_2eproto(&descriptor_table_modules_2fperception_2fonboard_2fproto_2fmotion_5fservice_2eproto);
namespace apollo {
namespace perception {
namespace onboard {
...
const ::PROTOBUF_NAMESPACE_ID::internal::LazyString MotionService::_i_give_permission_to_break_this_code_default_camera_names_{{{"front_6mm", 9}}, {nullptr}};
const ::PROTOBUF_NAMESPACE_ID::internal::LazyString MotionService::_i_give_permission_to_break_this_code_default_input_camera_channel_names_{{{"/apollo/sensor/camera/front_6mm/image", 37}}, {nullptr}};
const ::PROTOBUF_NAMESPACE_ID::internal::LazyString MotionService::_i_give_permission_to_break_this_code_default_input_localization_channel_name_{{{"/apollo/localization/pose", 25}}, {nullptr}};
const ::PROTOBUF_NAMESPACE_ID::internal::LazyString MotionService::_i_give_permission_to_break_this_code_default_output_topic_channel_name_{{{"/apollo/perception/motion_service", 33}}, {nullptr}};
...
MotionService::MotionService(const MotionService& from)
  ...
  input_localization_channel_name_.UnsafeSetDefault(nullptr);
  if (from._internal_has_input_localization_channel_name()) {
    input_localization_channel_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, from._internal_input_localization_channel_name(), 
      GetArenaForAllocation());
  }
  output_topic_channel_name_.UnsafeSetDefault(nullptr);
  if (from._internal_has_output_topic_channel_name()) {
    output_topic_channel_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, from._internal_output_topic_channel_name(), 
      GetArenaForAllocation());
  }
...
inline void MotionService::SharedDtor() {
  ...
  input_localization_channel_name_.DestroyNoArena(nullptr);
  output_topic_channel_name_.DestroyNoArena(nullptr);
}

void MotionService::ArenaDtor(void* object) {
  MotionService* _this = reinterpret_cast< MotionService* >(object);
  (void)_this;
}
void MotionService::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
void MotionService::InternalSwap(MotionService* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      nullptr,
      &input_localization_channel_name_, lhs_arena,
      &other->input_localization_channel_name_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      nullptr,
      &output_topic_channel_name_, lhs_arena,
      &other->output_topic_channel_name_, rhs_arena
  );
}
