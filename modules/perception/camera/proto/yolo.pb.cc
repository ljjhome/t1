...
namespace camera {
namespace yolo {
constexpr YoloParam::YoloParam(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : model_param_(nullptr)
  , net_param_(nullptr)
  , nms_param_(nullptr){}
struct YoloParamDefaultTypeInternal {
  constexpr YoloParamDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT YoloParamDefaultTypeInternal _YoloParam_default_instance_;
...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_modules_2fperception_2fcamera_2fproto_2fyolo_2eproto[6];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_modules_2fperception_2fcamera_2fproto_2fyolo_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_modules_2fperception_2fcamera_2fproto_2fyolo_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_modules_2fperception_2fcamera_2fproto_2fyolo_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
const char descriptor_table_protodef_modules_2fperception_2fcamera_2fproto_2fyolo_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ":\0011"
  ;
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_modules_2fperception_2fcamera_2fproto_2fyolo_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_modules_2fperception_2fcamera_2fproto_2fyolo_2eproto = {
  false, false, 3123, descriptor_table_protodef_modules_2fperception_2fcamera_2fproto_2fyolo_2eproto, "modules/perception/camera/proto/yolo.proto", 
  ...
  file_level_metadata_modules_2fperception_2fcamera_2fproto_2fyolo_2eproto, file_level_enum_descriptors_modules_2fperception_2fcamera_2fproto_2fyolo_2eproto, file_level_service_descriptors_modules_2fperception_2fcamera_2fproto_2fyolo_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_modules_2fperception_2fcamera_2fproto_2fyolo_2eproto_getter() {
  return &descriptor_table_modules_2fperception_2fcamera_2fproto_2fyolo_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_modules_2fperception_2fcamera_2fproto_2fyolo_2eproto(&descriptor_table_modules_2fperception_2fcamera_2fproto_2fyolo_2eproto);
namespace apollo {
namespace perception {
namespace camera {
namespace yolo {
...
void YoloParam::ArenaDtor(void* object) {
  YoloParam* _this = reinterpret_cast< YoloParam* >(object);
  (void)_this;
}
void YoloParam::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
void YoloParam::InternalSwap(YoloParam* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(YoloParam, nms_param_)
      + sizeof(YoloParam::nms_param_)
      - PROTOBUF_FIELD_OFFSET(YoloParam, model_param_)>(
...
const ::PROTOBUF_NAMESPACE_ID::internal::LazyString NetworkParam::_i_give_permission_to_break_this_code_default_input_blob_{{{"data", 4}}, {nullptr}};
...
NetworkParam::NetworkParam(const NetworkParam& from)
  ...
  input_blob_.UnsafeSetDefault(nullptr);
  if (from._internal_has_input_blob()) {
    input_blob_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, from._internal_input_blob(), 
      GetArenaForAllocation());
  }
...
inline void NetworkParam::SharedDtor() {
  ...
  input_blob_.DestroyNoArena(nullptr);
