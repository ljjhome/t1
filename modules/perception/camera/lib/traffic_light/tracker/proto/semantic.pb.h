...
class SemanticReviseParam final :
 ...
 public:
  ...
  explicit constexpr SemanticReviseParam(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline SemanticReviseParam* New() const final {
    return new SemanticReviseParam();
  }
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_hysteretic_threshold_count() const;
  void _internal_set_hysteretic_threshold_count(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SemanticReviseParam::_internal_hysteretic_threshold_count() const {
...
inline void SemanticReviseParam::_internal_set_hysteretic_threshold_count(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000001u;
