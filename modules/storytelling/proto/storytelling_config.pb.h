...
class StorytellingConfig final :
 ...
 public:
  ...
  explicit constexpr StorytellingConfig(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::storytelling::TopicConfig* release_topic_config();
...
inline void StorytellingConfig::set_allocated_topic_config(::apollo::storytelling::TopicConfig* topic_config) {
  ...
  if (topic_config) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::apollo::storytelling::TopicConfig>::GetOwningArena(topic_config);
