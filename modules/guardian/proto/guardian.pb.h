...
class GuardianCommand final :
 ...
 public:
  ...
  explicit constexpr GuardianCommand(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::control::ControlCommand* release_control_command();
