...
namespace cyber {
namespace proto {
constexpr ClassicTask::ClassicTask(
...
struct ClassicTaskDefaultTypeInternal {
  constexpr ClassicTaskDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT ClassicTaskDefaultTypeInternal _ClassicTask_default_instance_;
constexpr SchedGroup::SchedGroup(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : tasks_()
  , name_(nullptr)
...
struct SchedGroupDefaultTypeInternal {
  constexpr SchedGroupDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT SchedGroupDefaultTypeInternal _SchedGroup_default_instance_;
constexpr ClassicConf::ClassicConf(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : groups_(){}
struct ClassicConfDefaultTypeInternal {
  constexpr ClassicConfDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT ClassicConfDefaultTypeInternal _ClassicConf_default_instance_;
}  // namespace proto
}  // namespace cyber
}  // namespace apollo
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cyber_2fproto_2fclassic_5fconf_2eproto = {
  false, false, 381, descriptor_table_protodef_cyber_2fproto_2fclassic_5fconf_2eproto, "cyber/proto/classic_conf.proto", 
  ...
  file_level_metadata_cyber_2fproto_2fclassic_5fconf_2eproto, file_level_enum_descriptors_cyber_2fproto_2fclassic_5fconf_2eproto, file_level_service_descriptors_cyber_2fproto_2fclassic_5fconf_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_cyber_2fproto_2fclassic_5fconf_2eproto_getter() {
  return &descriptor_table_cyber_2fproto_2fclassic_5fconf_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_cyber_2fproto_2fclassic_5fconf_2eproto(&descriptor_table_cyber_2fproto_2fclassic_5fconf_2eproto);
namespace apollo {
namespace cyber {
namespace proto {
...
// @@protoc_insertion_point(message_clear_start:apollo.cyber.proto.SchedGroup)
  ...
  if (cached_has_bits & 0x0000000fu) {
    if (cached_has_bits & 0x00000001u) {
      name_.ClearToDefault(::apollo::cyber::proto::SchedGroup::_i_give_permission_to_break_this_code_default_name_, GetArenaForAllocation());
       }
    if (cached_has_bits & 0x00000002u) {
...
// @@protoc_insertion_point(message_byte_size_start:apollo.cyber.proto.SchedGroup)
  ...
  if (cached_has_bits & 0x0000003eu) {
    ...
    // optional uint32 processor_num = 2;
    if (cached_has_bits & 0x00000010u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_processor_num());
    }

    // optional int32 processor_prio = 6 [default = 0];
    if (cached_has_bits & 0x00000020u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_processor_prio());
    }
...
void SchedGroup::InternalSwap(SchedGroup* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &cpuset_, lhs_arena,
      &other->cpuset_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &processor_policy_, lhs_arena,
      &other->processor_policy_, rhs_arena
  );
