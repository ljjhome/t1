...
namespace cyber {
namespace proto {
constexpr PerfConf::PerfConf(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : enable_(false)
  , type_(4)
{}
struct PerfConfDefaultTypeInternal {
  constexpr PerfConfDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PerfConfDefaultTypeInternal _PerfConf_default_instance_;
}  // namespace proto
}  // namespace cyber
}  // namespace apollo
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cyber_2fproto_2fperf_5fconf_2eproto = {
  false, false, 196, descriptor_table_protodef_cyber_2fproto_2fperf_5fconf_2eproto, "cyber/proto/perf_conf.proto", 
  ...
  file_level_metadata_cyber_2fproto_2fperf_5fconf_2eproto, file_level_enum_descriptors_cyber_2fproto_2fperf_5fconf_2eproto, file_level_service_descriptors_cyber_2fproto_2fperf_5fconf_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_cyber_2fproto_2fperf_5fconf_2eproto_getter() {
  return &descriptor_table_cyber_2fproto_2fperf_5fconf_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_cyber_2fproto_2fperf_5fconf_2eproto(&descriptor_table_cyber_2fproto_2fperf_5fconf_2eproto);
namespace apollo {
namespace cyber {
namespace proto {
