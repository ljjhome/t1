...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cyber_2fproto_2fqos_5fprofile_2eproto = {
  false, false, 656, descriptor_table_protodef_cyber_2fproto_2fqos_5fprofile_2eproto, "cyber/proto/qos_profile.proto", 
  ...
  file_level_metadata_cyber_2fproto_2fqos_5fprofile_2eproto, file_level_enum_descriptors_cyber_2fproto_2fqos_5fprofile_2eproto, file_level_service_descriptors_cyber_2fproto_2fqos_5fprofile_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_cyber_2fproto_2fqos_5fprofile_2eproto_getter() {
  return &descriptor_table_cyber_2fproto_2fqos_5fprofile_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_cyber_2fproto_2fqos_5fprofile_2eproto(&descriptor_table_cyber_2fproto_2fqos_5fprofile_2eproto);
namespace apollo {
namespace cyber {
namespace proto {
...
// @@protoc_insertion_point(message_byte_size_start:apollo.cyber.proto.QosProfile)
  ...
  if (cached_has_bits & 0x0000001fu) {
    // optional uint32 mps = 3 [default = 0];
    if (cached_has_bits & 0x00000001u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_mps());
    }
