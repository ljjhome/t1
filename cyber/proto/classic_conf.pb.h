...
class ClassicTask final :
 ...
 public:
  ...
  explicit constexpr ClassicTask(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class SchedGroup final :
 ...
 public:
  ...
  ~SchedGroup() override;
  explicit constexpr SchedGroup(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class ClassicConf final :
 ...
 public:
  ...
  explicit constexpr ClassicConf(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline std::string* SchedGroup::_internal_mutable_name() {
  _has_bits_[0] |= 0x00000001u;
  return name_.Mutable(::apollo::cyber::proto::SchedGroup::_i_give_permission_to_break_this_code_default_name_, GetArenaForAllocation());
}
