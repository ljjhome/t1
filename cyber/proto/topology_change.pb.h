...
class ChangeMsg final :
 ...
 public:
  ...
  ~ChangeMsg() override;
  explicit constexpr ChangeMsg(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::cyber::proto::RoleAttributes* release_role_attr();
