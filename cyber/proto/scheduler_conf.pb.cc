...
namespace cyber {
namespace proto {
constexpr InnerThread::InnerThread(
...
struct InnerThreadDefaultTypeInternal {
  constexpr InnerThreadDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT InnerThreadDefaultTypeInternal _InnerThread_default_instance_;
constexpr SchedulerConf::SchedulerConf(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : threads_()
  , policy_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , process_level_cpuset_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cyber_2fproto_2fscheduler_5fconf_2eproto = {
  false, false, 482, descriptor_table_protodef_cyber_2fproto_2fscheduler_5fconf_2eproto, "cyber/proto/scheduler_conf.proto", 
  ...
  file_level_metadata_cyber_2fproto_2fscheduler_5fconf_2eproto, file_level_enum_descriptors_cyber_2fproto_2fscheduler_5fconf_2eproto, file_level_service_descriptors_cyber_2fproto_2fscheduler_5fconf_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_cyber_2fproto_2fscheduler_5fconf_2eproto_getter() {
  return &descriptor_table_cyber_2fproto_2fscheduler_5fconf_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_cyber_2fproto_2fscheduler_5fconf_2eproto(&descriptor_table_cyber_2fproto_2fscheduler_5fconf_2eproto);
namespace apollo {
namespace cyber {
namespace proto {
...
// @@protoc_insertion_point(message_byte_size_start:apollo.cyber.proto.SchedulerConf)
  ...
  if (cached_has_bits & 0x0000003fu) {
    ...
    // optional uint32 routine_num = 2;
    if (cached_has_bits & 0x00000010u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_routine_num());
    }

    // optional uint32 default_proc_num = 3;
    if (cached_has_bits & 0x00000020u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_default_proc_num());
    }
...
void SchedulerConf::InternalSwap(SchedulerConf* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &process_level_cpuset_, lhs_arena,
      &other->process_level_cpuset_, rhs_arena
  );
