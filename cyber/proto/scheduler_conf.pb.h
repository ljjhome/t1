...
class InnerThread final :
 ...
 public:
  ...
  explicit constexpr InnerThread(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_policy();
...
class SchedulerConf final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_process_level_cpuset();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::cyber::proto::ClassicConf* release_classic_conf();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::cyber::proto::ChoreographyConf* release_choreography_conf();
...
void SchedulerConf::set_process_level_cpuset(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 process_level_cpuset_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void SchedulerConf::_internal_set_process_level_cpuset(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  process_level_cpuset_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* SchedulerConf::_internal_mutable_process_level_cpuset() {
  _has_bits_[0] |= 0x00000002u;
  return process_level_cpuset_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* SchedulerConf::release_process_level_cpuset() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  return process_level_cpuset_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
