...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cyber_2fproto_2fproto_5fdesc_2eproto = {
  false, false, 130, descriptor_table_protodef_cyber_2fproto_2fproto_5fdesc_2eproto, "cyber/proto/proto_desc.proto", 
  ...
  file_level_metadata_cyber_2fproto_2fproto_5fdesc_2eproto, file_level_enum_descriptors_cyber_2fproto_2fproto_5fdesc_2eproto, file_level_service_descriptors_cyber_2fproto_2fproto_5fdesc_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_cyber_2fproto_2fproto_5fdesc_2eproto_getter() {
  return &descriptor_table_cyber_2fproto_2fproto_5fdesc_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_cyber_2fproto_2fproto_5fdesc_2eproto(&descriptor_table_cyber_2fproto_2fproto_5fdesc_2eproto);
namespace apollo {
namespace cyber {
namespace proto {
