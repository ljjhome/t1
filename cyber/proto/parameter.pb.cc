...
constexpr NodeName::NodeName(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : value_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string){}
struct NodeNameDefaultTypeInternal {
  constexpr NodeNameDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT NodeNameDefaultTypeInternal _NodeName_default_instance_;
constexpr ParamName::ParamName(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : value_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string){}
struct ParamNameDefaultTypeInternal {
  constexpr ParamNameDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT ParamNameDefaultTypeInternal _ParamName_default_instance_;
constexpr BoolResult::BoolResult(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : value_(false){}
struct BoolResultDefaultTypeInternal {
  constexpr BoolResultDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT BoolResultDefaultTypeInternal _BoolResult_default_instance_;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cyber_2fproto_2fparameter_2eproto = {
  false, false, 482, descriptor_table_protodef_cyber_2fproto_2fparameter_2eproto, "cyber/proto/parameter.proto", 
  ...
  file_level_metadata_cyber_2fproto_2fparameter_2eproto, file_level_enum_descriptors_cyber_2fproto_2fparameter_2eproto, file_level_service_descriptors_cyber_2fproto_2fparameter_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_cyber_2fproto_2fparameter_2eproto_getter() {
  return &descriptor_table_cyber_2fproto_2fparameter_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_cyber_2fproto_2fparameter_2eproto(&descriptor_table_cyber_2fproto_2fparameter_2eproto);
namespace apollo {
namespace cyber {
namespace proto {
...
// @@protoc_insertion_point(one_of_clear_start:apollo.cyber.proto.Param)
  switch (oneof_value_case()) {
    ...
    case kStringValue: {
      oneof_value_.string_value_.Destroy(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
      break;
    }
    case ONEOF_VALUE_NOT_SET: {
      break;
