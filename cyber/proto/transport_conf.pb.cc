...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cyber_2fproto_2ftransport_5fconf_2eproto = {
  false, false, 921, descriptor_table_protodef_cyber_2fproto_2ftransport_5fconf_2eproto, "cyber/proto/transport_conf.proto", 
  ...
  file_level_metadata_cyber_2fproto_2ftransport_5fconf_2eproto, file_level_enum_descriptors_cyber_2fproto_2ftransport_5fconf_2eproto, file_level_service_descriptors_cyber_2fproto_2ftransport_5fconf_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_cyber_2fproto_2ftransport_5fconf_2eproto_getter() {
  return &descriptor_table_cyber_2fproto_2ftransport_5fconf_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_cyber_2fproto_2ftransport_5fconf_2eproto(&descriptor_table_cyber_2fproto_2ftransport_5fconf_2eproto);
namespace apollo {
namespace cyber {
namespace proto {
...
void ShmConf::InternalSwap(ShmConf* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &notifier_type_, lhs_arena,
      &other->notifier_type_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &shm_type_, lhs_arena,
      &other->shm_type_, rhs_arena
  );
...
// @@protoc_insertion_point(message_byte_size_start:apollo.cyber.proto.RtpsParticipantAttr)
  ...
  if (cached_has_bits & 0x0000000fu) {
    // optional int32 lease_duration = 1 [default = 12];
    if (cached_has_bits & 0x00000001u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_lease_duration());
    }

    // optional int32 announcement_period = 2 [default = 3];
    if (cached_has_bits & 0x00000002u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_announcement_period());
    }

    // optional uint32 domain_id_gain = 3 [default = 200];
    if (cached_has_bits & 0x00000004u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_domain_id_gain());
    }

    // optional uint32 port_base = 4 [default = 10000];
    if (cached_has_bits & 0x00000008u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_port_base());
    }
...
// @@protoc_insertion_point(message_byte_size_start:apollo.cyber.proto.ResourceLimit)
  ...
  cached_has_bits = _has_bits_[0];
  if (cached_has_bits & 0x00000001u) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_max_history_depth());
  }
