...
struct ChangeMsgDefaultTypeInternal {
  constexpr ChangeMsgDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT ChangeMsgDefaultTypeInternal _ChangeMsg_default_instance_;
}  // namespace proto
}  // namespace cyber
}  // namespace apollo
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cyber_2fproto_2ftopology_5fchange_2eproto = {
  false, false, 591, descriptor_table_protodef_cyber_2fproto_2ftopology_5fchange_2eproto, "cyber/proto/topology_change.proto", 
  ...
  file_level_metadata_cyber_2fproto_2ftopology_5fchange_2eproto, file_level_enum_descriptors_cyber_2fproto_2ftopology_5fchange_2eproto, file_level_service_descriptors_cyber_2fproto_2ftopology_5fchange_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_cyber_2fproto_2ftopology_5fchange_2eproto_getter() {
  return &descriptor_table_cyber_2fproto_2ftopology_5fchange_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_cyber_2fproto_2ftopology_5fchange_2eproto(&descriptor_table_cyber_2fproto_2ftopology_5fchange_2eproto);
namespace apollo {
namespace cyber {
namespace proto {
