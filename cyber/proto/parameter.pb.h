...
class NodeName final :
 ...
 public:
  ...
  ~NodeName() override;
  explicit constexpr NodeName(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class ParamName final :
 ...
 public:
  ...
  ~ParamName() override;
  explicit constexpr ParamName(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class BoolResult final :
 ...
 public:
  ...
  ~BoolResult() override;
  explicit constexpr BoolResult(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline void Param::clear_int_value() {
  if (_internal_has_int_value()) {
    oneof_value_.int_value_ = int64_t{0};
    clear_has_oneof_value();
  }
}
...
inline void Param::set_string_value(ArgT0&& arg0, ArgT... args) {
  ...
  oneof_value_.string_value_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Param::_internal_set_string_value(const std::string& value) {
  ...
  oneof_value_.string_value_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
...
inline std::string* Param::release_string_value() {
  ...
  if (_internal_has_string_value()) {
    clear_has_oneof_value();
    return oneof_value_.string_value_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
  } else {
    return nullptr;
  }
}
