...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cyber_2fproto_2fdag_5fconf_2eproto = {
  false, false, 504, descriptor_table_protodef_cyber_2fproto_2fdag_5fconf_2eproto, "cyber/proto/dag_conf.proto", 
  ...
  file_level_metadata_cyber_2fproto_2fdag_5fconf_2eproto, file_level_enum_descriptors_cyber_2fproto_2fdag_5fconf_2eproto, file_level_service_descriptors_cyber_2fproto_2fdag_5fconf_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_cyber_2fproto_2fdag_5fconf_2eproto_getter() {
  return &descriptor_table_cyber_2fproto_2fdag_5fconf_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_cyber_2fproto_2fdag_5fconf_2eproto(&descriptor_table_cyber_2fproto_2fdag_5fconf_2eproto);
namespace apollo {
namespace cyber {
namespace proto {
...
void ModuleConfig::InternalSwap(ModuleConfig* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &module_library_, lhs_arena,
      &other->module_library_, rhs_arena
  );
}
