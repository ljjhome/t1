...
class UnitTest final :
 ...
 public:
  ...
  ~UnitTest() override;
  explicit constexpr UnitTest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_case_name();
...
class Chatter final :
 ...
 public:
  ...
  ~Chatter() override;
  explicit constexpr Chatter(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class ChatterBenchmark final :
 ...
 public:
  ...
  explicit constexpr ChatterBenchmark(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
void UnitTest::set_case_name(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 case_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void UnitTest::_internal_set_case_name(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  case_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* UnitTest::_internal_mutable_case_name() {
  _has_bits_[0] |= 0x00000002u;
  return case_name_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* UnitTest::release_case_name() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  return case_name_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
