...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cyber_2fproto_2fcomponent_5fconf_2eproto = {
  false, false, 443, descriptor_table_protodef_cyber_2fproto_2fcomponent_5fconf_2eproto, "cyber/proto/component_conf.proto", 
  ...
  file_level_metadata_cyber_2fproto_2fcomponent_5fconf_2eproto, file_level_enum_descriptors_cyber_2fproto_2fcomponent_5fconf_2eproto, file_level_service_descriptors_cyber_2fproto_2fcomponent_5fconf_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_cyber_2fproto_2fcomponent_5fconf_2eproto_getter() {
  return &descriptor_table_cyber_2fproto_2fcomponent_5fconf_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_cyber_2fproto_2fcomponent_5fconf_2eproto(&descriptor_table_cyber_2fproto_2fcomponent_5fconf_2eproto);
namespace apollo {
namespace cyber {
namespace proto {
...
// @@protoc_insertion_point(message_byte_size_start:apollo.cyber.proto.ReaderOption)
  ...
  if (cached_has_bits & 0x00000007u) {
    ...
    // optional uint32 pending_queue_size = 3 [default = 1];
    if (cached_has_bits & 0x00000004u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_pending_queue_size());
    }
...
void ComponentConfig::InternalSwap(ComponentConfig* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &config_file_path_, lhs_arena,
      &other->config_file_path_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &flag_file_path_, lhs_arena,
      &other->flag_file_path_, rhs_arena
  );
}
