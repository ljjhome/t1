...
class SocketAddr final :
 ...
 public:
  ...
  ~SocketAddr() override;
  explicit constexpr SocketAddr(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class RoleAttributes final :
 ...
 public:
  ...
  explicit constexpr RoleAttributes(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_host_ip();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::cyber::proto::QosProfile* release_qos_profile();
  ...
  PROTOBUF_MUST_USE_RESULT ::apollo::cyber::proto::SocketAddr* release_socket_addr();
...
void RoleAttributes::set_host_ip(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 host_ip_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void RoleAttributes::_internal_set_host_ip(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  host_ip_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* RoleAttributes::_internal_mutable_host_ip() {
  _has_bits_[0] |= 0x00000002u;
  return host_ip_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* RoleAttributes::release_host_ip() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  return host_ip_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
...
inline std::string* RoleAttributes::release_node_name() {
  ...
  _has_bits_[0] &= ~0x00000004u;
  return node_name_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
...
inline void RoleAttributes::set_allocated_socket_addr(::apollo::cyber::proto::SocketAddr* socket_addr) {
  ...
  if (socket_addr) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::apollo::cyber::proto::SocketAddr>::GetOwningArena(socket_addr);
    if (message_arena != submessage_arena) {
