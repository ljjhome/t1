...
class SamplesTest1 final :
 ...
 public:
  ...
  explicit constexpr SamplesTest1(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class Driver final :
 ...
 public:
  ...
  ~Driver() override;
  explicit constexpr Driver(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
