...
namespace examples {
namespace proto {
constexpr SamplesTest1::SamplesTest1(
...
struct SamplesTest1DefaultTypeInternal {
  constexpr SamplesTest1DefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT SamplesTest1DefaultTypeInternal _SamplesTest1_default_instance_;
...
constexpr Driver::Driver(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : content_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , msg_id_(uint64_t{0u})
  , timestamp_(uint64_t{0u}){}
struct DriverDefaultTypeInternal {
  constexpr DriverDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT DriverDefaultTypeInternal _Driver_default_instance_;
}  // namespace proto
}  // namespace examples
}  // namespace cyber
}  // namespace apollo
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_cyber_2fexamples_2fproto_2fexamples_2eproto = {
  false, false, 268, descriptor_table_protodef_cyber_2fexamples_2fproto_2fexamples_2eproto, "cyber/examples/proto/examples.proto", 
  ...
  file_level_metadata_cyber_2fexamples_2fproto_2fexamples_2eproto, file_level_enum_descriptors_cyber_2fexamples_2fproto_2fexamples_2eproto, file_level_service_descriptors_cyber_2fexamples_2fproto_2fexamples_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_cyber_2fexamples_2fproto_2fexamples_2eproto_getter() {
  return &descriptor_table_cyber_2fexamples_2fproto_2fexamples_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_cyber_2fexamples_2fproto_2fexamples_2eproto(&descriptor_table_cyber_2fexamples_2fproto_2fexamples_2eproto);
namespace apollo {
namespace cyber {
namespace examples {
namespace proto {
...
// @@protoc_insertion_point(message_byte_size_start:apollo.cyber.examples.proto.Driver)
  ...
  if (cached_has_bits & 0x00000007u) {
    ...
    // optional uint64 msg_id = 2;
    if (cached_has_bits & 0x00000002u) {
      total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt64SizePlusOne(this->_internal_msg_id());
    }
